...
public class StaffReviveCommand implements CommandExecutor, TabCompleter {
	...
	public StaffReviveCommand(LorexHCF plugin) {
		this.plugin = plugin;
	}
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		FactionUser factionTarget = LorexHCF.getInstance().getUserManager().getUser(targetUUID);
		...
		// ChatColor.GRAY + ChatColor.ITALIC + "(Click here to refund
		// items)").setHoverText(ChatColor.GREEN + "Click here to refund items for: " +
		// ChatColor.GRAY +
		// target.getPlayer().getName().setClick(ClickAction.RUN_COMMAND, "/inv " +
