package me.bruce.factions.armors.miner;
...
import me.bruce.factions.armors.event.PvpClassEquipEvent;
...
public class MinerClass extends PvpClass implements Listener {
	...
	public MinerClass(LorexHCF plugin) {
	...
	/**
	 * Applies the {@link MinerClass} invisibility {@link PotionEffect} depending on
	 * the {@link Player}s {@link Location}.
	 *
	 * @param player
