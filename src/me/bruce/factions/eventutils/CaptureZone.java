...
public class CaptureZone implements ConfigurationSerializable {
	...
	/**
	 * Constructs an {@link CaptureZone} with a given name, {@link Cuboid}, default
	 * capture time and an empty prefix.
	 *
	 * @param name
	...
	/**
	 * Constructs an {@link CaptureZone} with a given name, prefix, {@link Cuboid}
	 * and default capture time.
	 *
	 * @param name
	 *            the name to construct with
	 * @param prefix
	...
	/**
	 * Gets the remaining time in milliseconds until this {@link CaptureZone} will
	 * be captured.
	 *
	 * @return the remaining time in milliseconds until captured, or -1 if this is
	 *         not active
	 */
	...
	/**
	 * Sets the remaining time in milliseconds until this {@link CaptureZone} will
	 * be captured.
	 *
	 * @param millis
