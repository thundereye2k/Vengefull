...
public class SettingsYML {
	...
	public static void init(JavaPlugin plugin) {
		Config config = new Config(LorexHCF.getInstance(), "settings");
		...
		tablist = config.getBoolean("tablist", tablist);
		DONATE_URL = config.getString("donate_url", DONATE_URL);
	...
	public static String SCOREBOARD_TITLE = ChatColor.GOLD.toString() + ChatColor.BOLD + "idk" + ChatColor.RED
			+ "[Beta]";
