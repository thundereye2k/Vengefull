...
public class FlatFileEconomyManager implements EconomyManager {
	...
	private TObjectIntMap<UUID> balanceMap = new TObjectIntHashMap<>(Constants.DEFAULT_CAPACITY,
	...
	public void reloadEconomyData() {
		Object object = (this.balanceConfig = new Config(LorexHCF.getInstance(), "balances")).get("balances");
