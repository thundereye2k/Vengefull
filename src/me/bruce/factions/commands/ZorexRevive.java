...
public class ZorexRevive implements CommandExecutor{
    private final LorexHCF plugin;
    
    public ZorexRevive(final LorexHCF plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        if(args.length == 1) {
            ...
            Bukkit.broadcastMessage(ChatColor.translateAlternateColorCodes('&', "&7[&f&lREVIVE&7] &6&l" + sender.getName() + " &ehas used his &9&lZorex Rank &eto revive &A" + target.getName()));
