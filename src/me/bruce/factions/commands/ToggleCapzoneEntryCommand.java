...
public class ToggleCapzoneEntryCommand implements CommandExecutor, TabExecutor {
	...
	public ToggleCapzoneEntryCommand(LorexHCF plugin) {
		this.plugin = plugin;
	}
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		sender.sendMessage(
				ChatColor.YELLOW + "You will now " + (newStatus ? ChatColor.GREEN.toString() : ChatColor.RED + "un")
						+ "able" + ChatColor.YELLOW + " to see capture zone entry messages.");
