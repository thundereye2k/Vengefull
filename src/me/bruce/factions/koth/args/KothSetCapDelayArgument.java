...
/**
 * An {@link CommandArgument} used for setting the capture delay of an
 * {@link KothFaction}.
 */
public class KothSetCapDelayArgument extends CommandArgument {
	...
	public KothSetCapDelayArgument(LorexHCF plugin) {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		Bukkit.broadcastMessage(ChatColor.YELLOW + "The capture time of " + ChatColor.RED
				+ kothFaction.getDisplayName(sender) + ChatColor.YELLOW + " has been set to " + ChatColor.RED
	...
	public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
		...
		return plugin.getFactionManager().getFactions().stream().filter(faction -> faction instanceof KothFaction)
