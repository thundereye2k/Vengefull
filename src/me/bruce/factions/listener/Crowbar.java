...
public class Crowbar {
	...
	public static final String CROWBAR_NAME = ChatColor.AQUA.toString() + ChatColor.BOLD + "Crowbar";
	public static final String SPAWNER_USE_TAG = "Spawners";
	public static final String END_FRAME_USE_TAG = "End Frames";

	private static final String LORE_FORMAT = ChatColor.GRAY + "%1$s" + ChatColor.RED + " § " + ChatColor.GRAY
			+ "%2$s/%3$s";
	 ...
	 *
	 * @return the converted {@link ItemStack} or an {@link Material#AIR} if fully
	 *         used
	 */
	 ...
	 *
	 * @return the converted {@link ItemStack} or an {@link Optional#absent()} if
	 *         fully used
	 */
	public Optional<ItemStack> toItemStack() {
		if (needsMetaUpdate) {
			...
			meta.setLore(Arrays.asList(String.format(LORE_FORMAT, SPAWNER_USE_TAG, spawnerUses, MAX_SPAWNER_USES),
