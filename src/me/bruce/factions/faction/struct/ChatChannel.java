...
public enum ChatChannel {
	...
	public String getDisplayName() {
		...
		case FACTION:
			...
			break;
		case ALLIANCE:
			prefix = SettingsYML.ALLY_COLOUR.toString();
			break;
		case PUBLIC:
		default:
			prefix = SettingsYML.ENEMY_COLOUR.toString();
			break;
		}
	...
	public ChatChannel getRotation() {
		...
		case FACTION:
			return PUBLIC;
		case PUBLIC:
			return SettingsYML.MAX_ALLIES_PER_FACTION > 0 ? ALLIANCE : FACTION;
		case ALLIANCE:
			return FACTION;
		default:
			return PUBLIC;
	...
	public String getRawFormat(Player player) {
		switch (this) {
		case FACTION:
			return ChatColor.YELLOW + "(" + ChatColor.DARK_GREEN + "FC" +  ChatColor.YELLOW  + ") "
					+ player.getName() + ChatColor.GRAY + ": " + ChatColor.YELLOW + "%2$s";
		case ALLIANCE:
			return SettingsYML.ALLY_COLOUR + "(" + getDisplayName() + SettingsYML.ALLY_COLOUR + ") " + player.getName()
					+ ChatColor.GRAY + ": " + ChatColor.YELLOW + "%2$s";
		default:
