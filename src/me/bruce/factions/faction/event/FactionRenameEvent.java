...
/**
 * Event called when a {@link FactionListener} is about to be renamed.
 */
public class FactionRenameEvent extends FactionEvent implements Cancellable {
	...
	/**
	 * Gets the name before the {@link FactionListener} decided to perform the rename.
	 *
	...
	/**
	 * Gets the name the {@link FactionListener} is attempting to change to
	 *
	 * @return the new name
	 */
