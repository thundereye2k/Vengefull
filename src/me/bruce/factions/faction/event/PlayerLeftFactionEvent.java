...
/**
 * FactionListener event called when a user has left their {@link FactionListener}.
 */
public class PlayerLeftFactionEvent extends FactionEvent {
	...
	public PlayerLeftFactionEvent(CommandSender sender, @Nullable Player player, UUID playerUUID,
