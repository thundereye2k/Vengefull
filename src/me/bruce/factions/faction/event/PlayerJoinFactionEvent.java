...
/**
 * Event called when a user is about to join a {@link FactionListener}.
 */
public class PlayerJoinFactionEvent extends FactionEvent implements Cancellable {
	...
	public PlayerJoinFactionEvent(CommandSender sender, @Nullable Player player, UUID playerUUID,
