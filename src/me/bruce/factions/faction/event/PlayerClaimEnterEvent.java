...
/**
 * FactionListener event called when a {@link Player} enters a different {@link Claim}.
 */
public class PlayerClaimEnterEvent extends Event implements Cancellable {
	...
	public PlayerClaimEnterEvent(Player player, Location from, Location to, Faction fromFaction, Faction toFaction,
			EnterCause enterCause) {
		this.player = player;
		this.from = from;
		this.to = to;
	...
	/**
	 * Gets the {@link FactionListener} at the from {@link Location}.
	 *
	 * @return the {@link FactionListener} at the from {@link Location}
	 */
	...
	/**
	 * Gets the {@link FactionListener} at the to {@link Location}.
	 *
	 * @return the {@link FactionListener} at the to {@link Location}
	 */
