...
/**
 * FactionListener event called when a {@link Player} in a faction talks to their
 * relations.
 */
public class FactionChatEvent extends FactionEvent implements Cancellable {
	...
	public FactionChatEvent(boolean async, PlayerFaction faction, Player player, ChatChannel chatChannel,
			Collection<? extends CommandSender> recipients, String message) {
		super(faction, async);
		this.player = player;
