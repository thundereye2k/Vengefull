...
public abstract class Faction implements ConfigurationSerializable {
	...
	/**
	 * Gets the unique ID of this {@link FactionListener}.
	 *
	...
	/**
	 * Gets the name of this {@link FactionListener}.
	 *
	 * @return the name
	 */
	...
	/**
	 * Sets the name of this {@link FactionListener}.
	 *
	 * @param name
	 *            the name to set
	...
	public Relation getRelation(CommandSender sender) {
		return sender instanceof Player
				? getFactionRelation(LorexHCF.getInstance().getFactionManager().getPlayerFaction((Player) sender))
				: Relation.ENEMY;
	}

	/**
	 * Gets the display name of this {@link FactionListener} to a viewing
	 * {@link CommandSender}.
	 *
	 * @param sender
	...
	public String getDisplayName(CommandSender sender) {
		return (safezone ? SettingsYML.SAFEZONE_COLOUR : getRelation(sender).toChatColour()) + name;
	}

	/**
	 * Gets the display name of this {@link FactionListener} to a viewing {@link FactionListener}.
	 *
	 * @param other
	 *            the target {@link FactionListener} to get for
	 * @return the display name for the viewer
	 */
	...
	/**
	 * Checks if a deathban will be applied when players are killed in the territory
	 * of this {@link FactionListener}.
	 *
	...
	/**
	 * Sets if a deathban will be applied when players are killed in the territory
	 * of this {@link FactionListener}.
	 * <p>
	...
	/**
	 * Gets the deathban multiplier when players are killed in the territory of this
	...
	/**
	 * Sets the deathban multiplier when players are killed in the territory of this
	 * {@link FactionListener}.
	 * <p>
	 * To disable deathbans completely, set the multiplier to 0
	 * </p>
	...
	/**
	 * Checks if this {@link FactionListener} is a safezone protecting {@link Player}s from
	 * PVP and PVE.
	 *
