 ...
 * <p>
 * Cannot be a {@link Cuboid} as the implementation doesn't allow null
 * locations.
 * </p>
 */
public class ClaimSelection implements Cloneable {
	...
	/**
	 * Constructs a new {@link ClaimSelection} from a given {@link World} and two
	 * {@link Location}s.
	 *
	 * @param pos1
	 ...
	 *
	 * @param playerFaction
	 *            the {@link FactionListener} looking up
	 * @param selling
	 *            if the {@link FactionListener} is selling this {@link ClaimSelection}
	...
	public int getPrice(PlayerFaction playerFaction, boolean selling) {
		...
		return pos1 == null || pos2 == null ? 0
				: LorexHCF.getInstance().getClaimHandler().calculatePrice(new Cuboid(pos1, pos2),
	...
	public Claim toClaim(Faction faction) {
		Preconditions.checkNotNull(faction, "FactionListener cannot be null");
