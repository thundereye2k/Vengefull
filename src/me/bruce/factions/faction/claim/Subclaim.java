...
/**
 * A implementation of {@link Claim} that denies other {@link FactionMember}s to
...
public class Subclaim extends Claim implements Cloneable, ConfigurationSerializable {
	...
	public Subclaim(Map<String, Object> map) {
		super(map);
		accessibleMembers.addAll(GenericUtils.createList(map.get("accessibleMembers"), String.class).stream()
	...
	public boolean equals(Object o) {
		...
		return !(accessibleMembers != null ? !accessibleMembers.equals(blocks.accessibleMembers)
				: blocks.accessibleMembers != null);
	}
