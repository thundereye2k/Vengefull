...
public class FactionLeaderArgument extends CommandArgument {
	...
	public FactionLeaderArgument(LorexHCF plugin) {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		playerFaction.broadcast(SettingsYML.TEAMMATE_COLOUR + selfMember.getRole().getAstrix() + selfMember.getName()
				+ ChatColor.YELLOW + " has transferred the faction to " + SettingsYML.TEAMMATE_COLOUR
				+ targetMember.getRole().getAstrix() + targetMember.getName() + ChatColor.YELLOW + '.');
