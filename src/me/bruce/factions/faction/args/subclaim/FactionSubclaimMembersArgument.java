...
/**
 * FactionListener subclaim argument used to list the names of members who have access
 * to a {@link Subclaim}.
 */
public class FactionSubclaimMembersArgument extends CommandArgument {
	...
	public FactionSubclaimMembersArgument(LorexHCF plugin) {
		super("listmembers", "ListCommand members of a subclaim", new String[] { "listplayers" });
		this.plugin = plugin;
	}
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		sender.sendMessage(ChatColor.YELLOW + "Non-officers accessible of subclaim " + subclaim.getName() + " ("
				+ memberNames.size() + "): " + ChatColor.AQUA + StringUtils.join(memberNames, ", "));
