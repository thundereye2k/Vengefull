...
public class FactionSubclaimAddMemberArgument extends CommandArgument {
	...
	public FactionSubclaimAddMemberArgument(LorexHCF plugin) {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (!subclaim.getAccessibleMembers().add(targetMember.getUniqueId())) {
			sender.sendMessage(ChatColor.RED + targetMember.getName() + " already has access to subclaim "
					+ subclaim.getName() + '.');
			return true;
		}

		sender.sendMessage(ChatColor.YELLOW + "Added member " + targetMember.getName() + " to subclaim "
				+ subclaim.getName() + '.');
		return true;
	}
