...
public class FactionUnclaimArgument extends CommandArgument {
	...
	public FactionUnclaimArgument(LorexHCF plugin) {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		playerFaction.broadcast(
				ChatColor.RED + ChatColor.BOLD.toString() + factionMember.getRole().getAstrix() + sender.getName()
						+ " has removed " + removingAmount + " claim" + (removingAmount > 1 ? "s" : "") + '.');
