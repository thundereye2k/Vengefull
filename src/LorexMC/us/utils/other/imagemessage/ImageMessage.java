...
public final class ImageMessage {
	...
	private ImageMessage(final BufferedImage image, final int height, final char imageCharacter)
			throws IllegalArgumentException {
		this(toImageMessage(toColourArray(image, height), imageCharacter));
	}

	public static ImageMessage newInstance(final BufferedImage image, final int height, final char imageCharacter)
			throws IllegalArgumentException {
	...
	public static ImageMessage newInstance(final String url, final int height, final char imageCharacter)
			throws IllegalArgumentException {
	...
	public static ImageMessage newInstance(final String fileName, final File folder, final int height,
			final char imageCharacter) throws IllegalArgumentException {
	...
	static {
		colors = new Color[] { new Color(0, 0, 0), new Color(0, 0, 170), new Color(0, 170, 0), new Color(0, 170, 170),
