package LorexMC.us.utils.other.cuboid;
...
public class NamedCuboid extends Cuboid {
	...
	public NamedCuboid(final World world, final int x1, final int y1, final int z1, final int x2, final int y2,
			final int z2) {
	...
	public String toString() {
		return "NamedCuboid: " + this.worldName + ',' + this.x1 + ',' + this.y1 + ',' + this.z1 + "=>" + this.x2 + ','
				+ this.y2 + ',' + this.z2 + ':' + this.name;
	}
}
