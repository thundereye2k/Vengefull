...
public class ConcurrentValueOrderedMap<K, V extends Comparable<V>> extends AbstractMap<K, V>
	...
	private static class InternalEntry<K, V extends Comparable<V>>
			implements Comparable<InternalEntry<K, V>>, Entry<K, V> {
		private final K key;
