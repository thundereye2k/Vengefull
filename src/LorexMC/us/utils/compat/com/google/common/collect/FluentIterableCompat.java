package LorexMC.us.utils.compat.com.google.common.collect;
...
public abstract class FluentIterableCompat<E> implements Iterable<E> {
	...
	public static <E> FluentIterableCompat<E> from(final Iterable<E> iterable) {
		return (iterable instanceof FluentIterableCompat) ? ((FluentIterableCompat) iterable)
	...
	public final ImmutableList<E> toList() {
		return ImmutableList.copyOf((Iterable) this.iterable);
	}
}
