...
public class BagUtils {
	...
	// -----------------------------------------------------------------------
	/**
	 * Returns a synchronized (thread-safe) bag backed by the given bag. In order to
	 * guarantee serial access, it is critical that all access to the backing bag is
	 * accomplished through the returned bag.
	 * <p>
	 * It is imperative that the user manually synchronize on the returned bag when
	 * iterating over it:
	 *
	 * <pre>
	...
	/**
	 * Returns an unmodifiable view of the given bag. Any modification attempts to
	 * the returned bag will raise an {@link UnsupportedOperationException}.
	 *
	 * @param <E>
	 *            the element type
	 * @param bag
	 *            the bag whose unmodifiable view is to be returned, must not be
	 *            null
	 ...
	 * bag. Trying to add an invalid object results in an IllegalArgumentException.
	 * It is important not to use the original bag after invoking this method, as it
	 * is a backdoor for adding invalid objects.
	 *
	 * @param <E>
	 *            the element type
	 * @param bag
	 *            the bag to predicate, must not be null
	 * @param predicate
	 ...
	 * <p>
	 * Each object is passed through the transformer as it is added to the Bag. It
	 * is important not to use the original bag after invoking this method, as it is
	 * a backdoor for adding untransformed objects.
	 * <p>
	 * Existing entries in the specified bag will not be transformed. If you want
	 * that behaviour, see {@link TransformedBag#transformedBag(Bag, Transformer)}.
	 *
	 * @param <E>
	 *            the element type
	 * @param bag
	...
	/**
	 * Returns a bag that complies to the Collection contract, backed by the given
	 * bag.
	 *
	 * @param <E>
	 *            the element type
	...
	// -----------------------------------------------------------------------
	/**
	 * Returns a synchronized (thread-safe) sorted bag backed by the given sorted
	 * bag. In order to guarantee serial access, it is critical that all access to
	 * the backing bag is accomplished through the returned bag.
	 * <p>
	 * It is imperative that the user manually synchronize on the returned bag when
	 * iterating over it:
	 *
	 ...
	 *            the element type
	 * @param bag
	 *            the sorted bag to predicate, must not be null
	 * @param predicate
	 *            the predicate for the bag, must not be null
	 * @return a predicated bag backed by the given bag
	 * @throws NullPointerException
