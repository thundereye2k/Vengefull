...
public class LoopingIterator<E> implements ResettableIterator<E> {
	 ...
	 * <p>
	 * There is no way to reset an Iterator instance without recreating it from the
	 * original source, so the Collection must be passed in.
	 *
	 * @param coll
	 ...
	 * <p>
	 * Returns false only if the collection originally had zero elements, or all the
	 * elements have been {@link #remove removed}.
	 *
	 ...
	 *             if there are no elements at all. Use {@link #hasNext} to avoid
	 *             this error.
	 */
	@Override
	public E next() {
	 ...
	 * {@link Collection#iterator iterator} method returns an implementation that
	 * supports it.
	 * <p>
	 * This method can only be called after at least one {@link #next} method call.
	 * After a removal, the remove method may not be called again until another next
	 * has been performed. If the {@link #reset} is called, then remove may not be
	 * called until {@link #next} is called again.
	 */
	@Override
	public void remove() {
		iterator.remove();
