...
public class CollatingIterator<E> implements Iterator<E> {
	...
	/**
	 * Index of the {@link #iterators iterator} from whom the last returned value
	 * was obtained.
	 */
	...
	// ----------------------------------------------------------------------
	/**
	 * Constructs a new <code>CollatingIterator</code>. A comparator must be set by
	 * calling {@link #setComparator(Comparator)} before invoking
	 * {@link #hasNext()}, or {@link #next()} for the first time. Child iterators
	 * will have to be manually added using the {@link #addIterator(Iterator)}
	 * method.
	 */
	...
	/**
	 * Constructs a new <code>CollatingIterator</code> that will used the specified
	 * comparator for ordering. Child iterators will have to be manually added using
	 * the {@link #addIterator(Iterator)} method.
	 *
	 * @param comp
	 *            the comparator to use to sort; must not be null, unless you'll be
	 *            invoking {@link #setComparator(Comparator)} later on.
	 */
	...
	/**
	 * Constructs a new <code>CollatingIterator</code> that will used the specified
	 * comparator for ordering and have the specified initial capacity. Child
	...
	/**
	 * Constructs a new <code>CollatingIterator</code> that will use the specified
	 * comparator to provide ordered iteration over the two given iterators.
	 *
	 * @param comp
	 *            the comparator to use to sort; must not be null, unless you'll be
	 *            invoking {@link #setComparator(Comparator)} later on.
	 * @param a
	 *            the first child ordered iterator
	 * @param b
	...
	/**
	 * Constructs a new <code>CollatingIterator</code> that will use the specified
	 * comparator to provide ordered iteration over the array of iterators.
	 *
	 * @param comp
	 *            the comparator to use to sort; must not be null, unless you'll be
	 *            invoking {@link #setComparator(Comparator)} later on.
	...
	/**
	 * Constructs a new <code>CollatingIterator</code> that will use the specified
	 * comparator to provide ordered iteration over the collection of iterators.
	 *
	 * @param comp
	 *            the comparator to use to sort; must not be null, unless you'll be
	 *            invoking {@link #setComparator(Comparator)} later on.
	 ...
	 *             if the iterators collection contains an element that's not an
	 *             {@link Iterator}
	 */
	...
	/**
	 * Sets the {@link Comparator} by which collation occurs. If you would like to
	 * use the natural sort order (or, in other words, if the elements in the
	 * iterators are implementing the {@link java.lang.Comparable} interface), then
	 * use the
	 * {@link org.apache.commons.collections4.comparators.ComparableComparator}.
	 *
	 * @param comp
	 *            the {@link Comparator} to set
	 * @throws IllegalStateException
	 *             if iteration has started
	 */
	 ...
	 *
	 * @throws IllegalStateException
	 *             if there is no last returned element, or if the last returned
	...
	/**
	 * Returns the index of the least element in {@link #values}, {@link #set(int)
	...
	/**
	 * Returns <code>true</code> iff any {@link Iterator} in the given list has a
	 * next value.
	 */
