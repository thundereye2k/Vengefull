...
public class ObjectGraphIterator<E> implements Iterator<E> {
	 ...
	 *
	 * @param root
	 *            the root object, null will result in an empty iterator
	 * @param transformer
	 ...
	 * <p>
	 * This constructor exists for convenience to emphasise that this class can be
	 * used to iterate over nested iterators. That is to say that the iterator
	 ...
	 * <p>
	 * This method calls remove() on the underlying Iterator and it may throw an
