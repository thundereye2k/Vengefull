 ...
 * {@link Iterator Iterator} instances.
 *
 * @since 1.0
...
public class EnumerationIterator<E> implements Iterator<E> {
	...
	// -----------------------------------------------------------------------
	/**
	 * Constructs a new <code>EnumerationIterator</code> that will not function
	 * until {@link #setEnumeration(Enumeration)} is called.
	 */
	...
	/**
	 * Constructs a new <code>EnumerationIterator</code> that provides an iterator
	 ...
	 * <p>
	 * Functions if an associated <code>Collection</code> is known. If so, the first
	 * occurrence of the last returned object from this iterator will be removed
	 * from the collection.
	 *
