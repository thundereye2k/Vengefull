 ...
 * into a ListCommand and creating a new Iterator.
 * <p>
 ...
 * been removed and {@link #size()} will return the number of remaining
...
public class IteratorChain<E> implements Iterator<E> {
	...
	/**
	 * ComparatorChain is "locked" after the first time compare(Object,Object) is
	 * called
	 */
	 ...
	 * <p>
	 * This method takes one iterator. The newly constructed iterator will iterate
	 * through that iterator. Thus calling this constructor on its own will have no
	 * effect other than decorating the input iterator.
	 * <p>
	 ...
	 * <p>
	 * This method takes two iterators. The newly constructed iterator will iterate
	 ...
	 * <p>
	 * This method takes an array of iterators. The newly constructed iterator will
	 ...
	 * IteratorChains cannot be modified once they have executed a method from the
	 * Iterator interface.
	 *
	...
	/**
	 * Lock the chain so no more iterators can be added. This must be called from
	 * all Iterator interface methods.
	 */
