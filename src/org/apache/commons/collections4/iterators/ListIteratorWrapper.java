...
/**
 * Converts an {@link Iterator} into a {@link ResettableListIterator}. For plain
 * <code>Iterator</code>s this is accomplished by caching the returned elements.
 * This class can also be used to simply add
 * {@link org.apache.commons.collections4.ResettableIterator ResettableIterator}
 * functionality to a given {@link ListIterator}.
 * <p>
 * The <code>ListIterator</code> interface has additional useful methods for
 * navigation - <code>previous()</code> and the index methods. This class allows
 * a regular <code>Iterator</code> to behave as a <code>ListIterator</code>. It
 * achieves this by building a list internally of as the underlying iterator is
 * traversed.
 * <p>
...
public class ListIteratorWrapper<E> implements ResettableListIterator<E> {
	...
	/**
	 * recall whether the wrapped iterator's "cursor" is in such a state as to allow
	 * remove() to be called
	 */
	...
	// -------------------------------------------------------------------------
	/**
	 * Constructs a new <code>ListIteratorWrapper</code> that will wrap the given
	 * iterator.
	 *
	 * @param iterator
	 ...
	 * <code>Iterator</code> is a <code>ListIterator</code>.
	 *
	 * @param obj
	 *            the object to add
	 * @throws UnsupportedOperationException
	 *             if the underlying iterator is not of type {@link ListIterator}
	 */
	@Override
	...
	/**
	 * Throws {@link UnsupportedOperationException} if {@link #previous()} has ever
	 * been called.
	 *
	 * @throws UnsupportedOperationException
	 *             always
