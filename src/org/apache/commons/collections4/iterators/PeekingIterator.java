 ...
 * <p>
 * The decorator supports the removal operation, but an
 * {@link IllegalStateException} will be thrown if {@link #remove()} is called
 * directly after a call to {@link #peek()} or {@link #element()}.
 *
 * @since 4.0
...
public class PeekingIterator<E> implements Iterator<E> {
	...
	/**
	 * Returns the next element in iteration without advancing the underlying
	 * iterator. If the iterator is already exhausted, null will be returned.
	 * <p>
	 * Note: this method does not throw a {@link NoSuchElementException} if the
	 * iterator is already exhausted. If you want such a behavior, use
	 ...
	 *             if the iterator is already exhausted according to
	 *             {@link #hasNext()}
	 */
	public E element() {
		fill();
	 ...
	 *             if {@link #peek()} or {@link #element()} has been called prior to
