 ...
 * <p>
 * This iterator decorates the underlying iterator, only allowing through those
 * elements that match the specified {@link Predicate Predicate}.
 *
 * @since 2.0
...
public class FilterListIterator<E> implements ListIterator<E> {
	...
	/**
	 * Whether or not the {@link #nextObject} has been set (possibly to
	 * <code>null</code>).
	 */
	private boolean nextObjectSet = false;

	/**
	 * The value of the previous (matching) object, when {@link #previousObjectSet}
	 * is true.
	 */
	private E previousObject;

	/**
	 * Whether or not the {@link #previousObject} has been set (possibly to
	 * <code>null</code>).
	 */
	...
	// -----------------------------------------------------------------------
	/**
	 * Constructs a new <code>FilterListIterator</code> that will not function until
	 * {@link #setListIterator(ListIterator) setListIterator} and
	 * {@link #setPredicate(Predicate) setPredicate} are invoked.
	 */
	...
	/**
	 * Constructs a new <code>FilterListIterator</code> that will not function until
	 * {@link #setListIterator(ListIterator) setListIterator} is invoked.
	 *
	 * @param predicate
	 *            the predicate to use.
	 */
