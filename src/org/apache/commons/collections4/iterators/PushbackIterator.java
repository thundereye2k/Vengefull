 ...
 * element that has been pushed back, will be returned as the next element in a
 * call to {@link #next()}.
 * <p>
 * The decorator does not support the removal operation. Any call to
 * {@link #remove()} will result in an {@link UnsupportedOperationException}.
 *
 * @since 4.0
