 ...
 *
 * @since 2.1
 * @version $Id: SingletonListIterator.java 1612021 2014-07-20 04:51:05Z
 *          ggregory $
 */
public class SingletonListIterator<E> implements ResettableListIterator<E> {
	...
	/**
	 * Returns the index of the element that would be returned by a subsequent call
	 * to {@code previous}. A return value of -1 indicates that the iterator is
	 * currently at the start.
	 *
	 * @return 0 or -1 depending on current state.
	 */
	@Override
	 ...
	 *             if the {@code next} or {@code previous} method has not yet been
	 ...
	 *            the object to set
	 * @throws IllegalStateException
	 *             if {@code next} has not been called or the object has been
	 *             removed
	 */
	@Override
