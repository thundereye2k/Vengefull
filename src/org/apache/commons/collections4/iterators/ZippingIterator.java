...
/**
 * Provides an interleaved iteration over the elements contained in a collection
 * of Iterators.
 * <p>
...
public class ZippingIterator<E> implements Iterator<E> {
	...
	/**
	 * Constructs a new <code>ZippingIterator</code> that will provide interleaved
	 * iteration over the two given iterators.
	 *
	 * @param a
	...
	/**
	 * Constructs a new <code>ZippingIterator</code> that will provide interleaved
	 * iteration over the three given iterators.
	 *
	 * @param a
	 *            the first child iterator
	 * @param b
	...
	/**
	 * Constructs a new <code>ZippingIterator</code> that will provide interleaved
	 * iteration of the specified iterators.
	 *
	 * @param iterators
