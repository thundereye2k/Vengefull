 ...
 * {@link Iterable Iterable} instance. The iterable can be constructed in one of
 * two variants: single use, multiple use.
 *
 * <p>
 * In the single use iterable case, the iterable is only usable for one
 * iterative operation over the source iterator. Subsequent iterative operations
 * use the same, exhausted source iterator. To create a single use iterable,
 * construct a new {@link IteratorIterable} using a {@link Iterator} that is NOT
 * a {@link ResettableIterator} iterator:
 * 
 * <pre>
...
public class IteratorIterable<E> implements Iterable<E> {
	...
	/**
	 * Factory method to create an {@link Iterator Iterator} from another iterator
	 * over objects of a different subtype.
	 */
	 ...
	 *            the iterator to use.
	 * @param multipleUse
	 *            <code>true</code> if the new iterable can be used in multiple
	 *            iterations
	 */
