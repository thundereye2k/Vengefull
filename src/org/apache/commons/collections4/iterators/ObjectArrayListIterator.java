 ...
 * array cannot be structurally modified. The {@link #set} method is supported
 * however.
 * <p>
 * The iterator implements a {@link #reset} method, allowing the reset of the
 * iterator back to the start if required.
 *
...
public class ObjectArrayListIterator<E> extends ObjectArrayIterator<E> implements ResettableListIterator<E> {
	...
	// -------------------------------------------------------------------------
	/**
	 * Constructs an ObjectArrayListIterator that will iterate over the values in
	 * the specified array.
	 *
	 * @param array
	...
	/**
	 * Constructs an ObjectArrayListIterator that will iterate over the values in
	 * the specified array from a specific start index.
	 *
	 * @param array
	 *            the array to iterate over
	 * @param start
	...
	/**
	 * This iterator does not support modification of its backing array's size, and
	 * so will always throw an {@link UnsupportedOperationException} when this
	 * method is invoked.
	 *
	 * @param obj
	 *            the object to add
