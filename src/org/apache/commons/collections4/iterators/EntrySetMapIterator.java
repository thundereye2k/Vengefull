...
/**
 * Implements a <code>MapIterator</code> using a Map entrySet. Reverse iteration
 * is not supported.
 * 
 * <pre>
...
public class EntrySetMapIterator<K, V> implements MapIterator<K, V>, ResettableIterator<K> {
	 ...
	 * @throws IllegalStateException
	 *             if <code>remove()</code> has already been called since the last
	 ...
	 *             if <code>next()</code> has not yet been called
	 * @throws IllegalStateException
	 *             if <code>remove()</code> has been called since the last call to
	 *             <code>next()</code>
	 */
	@Override
