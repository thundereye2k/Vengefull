...
public class FilterIterator<E> implements Iterator<E> {
	...
	// -----------------------------------------------------------------------
	/**
	 * Constructs a new <code>FilterIterator</code> that will not function until
	 * {@link #setIterator(Iterator) setIterator} is invoked.
	 */
	...
	/**
	 * Constructs a new <code>FilterIterator</code> that will use the given iterator
	 * and predicate.
	 *
	 * @param iterator
	 *            the iterator to use
	...
	// -----------------------------------------------------------------------
	/**
	 * Returns true if the underlying iterator contains an object that matches the
	 * predicate.
	 *
	...
	// -----------------------------------------------------------------------
	/**
	 * Set nextObject to the next object. If there are no more objects then return
