 ...
 * for actual bitwise {@link Trie} implementations.
 *
 * @since 4.0
...
public abstract class AbstractBitwiseTrie<K, V> extends AbstractMap<K, V> implements Trie<K, V>, Serializable {
	...
	/**
	 * A utility method to cast keys. It actually doesn't cast anything. It's just
	...
	/**
	 * Returns whether or not the given bit on the key is set or false if the key is
	 * null.
	 *
