...
public class ArrayStack<E> extends ArrayList<E> {
	 ...
	 * <p>
	 * This method exists for compatibility with <code>java.util.Stack</code>. New
	 * users of this class should use <code>isEmpty</code> instead.
	 *
	...
	/**
	 * Returns the n'th item down (zero-relative) from the top of this stack without
	 * removing it.
	 *
	 * @param n
	 ...
	 * considered to be at distance <code>1</code>. If the object is not present on
	 * the stack, return <code>-1</code> instead. The <code>equals()</code> method
	 * is used to compare to the items in this stack.
	 *
	 * @param object
