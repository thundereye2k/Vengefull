...
/**
 * Decorates another <code>ListCommand</code> to validate that all additions match a
 * specified predicate.
 * <p>
 * This list exists to provide validation for the decorated list. It is normally
 * created to decorate an empty list. If an object cannot be added to the list,
 ...
 * {
 * 	&#64;code
 * 	ListCommand<String> list = PredicatedList.predicatedList(new ArrayList<String>(), PredicateUtils.notNullPredicate());
 * }
 * </pre>
 * <p>
