...
/**
 * Decorates another <code>ListCommand</code> to create objects in the list on demand.
 * <p>
 ...
 *     }
 * }
 * ListCommand&lt;Date&gt; lazy = LazyList.decorate(new ArrayList&lt;Date&gt;(), factory);
 ...
 * <p>
 * This class differs from {@link GrowthList} because here growth occurs on get,
 * where <code>GrowthList</code> grows on set and add. However, they could
 * easily be used together by decorating twice.
 * <p>
...
public class LazyList<E> extends AbstractSerializableListDecorator<E> {
	 ...
	 * to the new size and a new object will be returned from the factory. Indexes
	 * in-between the old size and the requested size are left with a placeholder
	 * that is replaced with a factory object when requested.
	 *
	 * @param index
