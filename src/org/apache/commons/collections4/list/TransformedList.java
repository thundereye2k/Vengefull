...
/**
 * Decorates another <code>ListCommand</code> to transform objects that are added.
 * <p>
 * The add and set methods are affected by this class. Thus objects must be
...
public class TransformedList<E> extends TransformedCollection<E> implements List<E> {
	 ...
	 * <p>
	 * If there are any elements already in the list being decorated, they are NOT
	 * transformed. Contrast this with {@link #transformedList(ListCommand, Transformer)}.
	 *
	 * @param <E>
	...
	/**
	 * Factory method to create a transforming list that will transform existing
	 * contents of the specified list.
	 * <p>
	 * If there are any elements already in the list being decorated, they will be
	 * transformed by this method. Contrast this with
	 * {@link #transformingList(ListCommand, Transformer)}.
	 *
	 * @param <E>
	 *            the type of the elements in the list
	 * @param list
	 ...
	 * @param transformer
	 *            the transformer to use for conversion, must not be null
	 * @return a new transformed ListCommand
	 * @throws NullPointerException
	 *             if list or transformer is null
	 * @since 4.0
	 */
