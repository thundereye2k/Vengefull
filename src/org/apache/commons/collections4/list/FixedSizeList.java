...
/**
 * Decorates another <code>ListCommand</code> to fix the size preventing add/remove.
 * <p>
...
public class FixedSizeList<E> extends AbstractSerializableListDecorator<E> implements BoundedCollection<E> {
	...
	public boolean add(final E object) {
		throw new UnsupportedOperationException("ListCommand is fixed size");
	}
	...
	/**
	 * ListCommand iterator that only permits changes via set()
	 */
