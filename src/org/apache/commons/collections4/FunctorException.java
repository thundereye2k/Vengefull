...
/**
 * Runtime exception thrown from functors. If required, a root cause error can
 * be wrapped within this one.
 *
 * @since 3.0
...
public class FunctorException extends RuntimeException {
	...
	/**
	 * Constructs a new <code>FunctorException</code> without specified detail
	 * message.
	 */
	...
	/**
	 * Constructs a new <code>FunctorException</code> with specified nested
