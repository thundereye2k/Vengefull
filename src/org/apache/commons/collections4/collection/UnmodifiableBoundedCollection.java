 ...
 * longer accessible. The factory on this class will attempt to retrieve the
 ...
 *
 * @since 3.0
 * @version $Id: UnmodifiableBoundedCollection.java 1686855 2015-06-22 13:00:27Z
 *          tn $
 */
public final class UnmodifiableBoundedCollection<E> extends AbstractCollectionDecorator<E>
	 ...
	 * @param coll
	 *            the <code>BoundedCollection</code> to decorate, must not be null
	 * @return a new unmodifiable bounded collection
	 * @throws NullPointerException
	 *             if {@code coll} is {@code null}
	 * @since 4.0
	 */
	 ...
	 *             if coll is not a {@code BoundedCollection}
	 * @since 4.0
	 */
