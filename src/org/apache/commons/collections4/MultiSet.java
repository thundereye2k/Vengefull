 ...
 * collection.
 * <p>
 * Suppose you have a MultiSet that contains <code>{a, a, b, c}</code>. Calling
...
public interface MultiSet<E> extends Collection<E> {
	...
	/**
	 * Returns the number of occurrences of the given object currently in the
	...
	/**
	 * Sets the number of occurrences of the specified object in the MultiSet to the
	 * given count.
	 * <p>
	 ...
	 * @param object
	 *            the object to add
	 * @return <code>true</code> always, as the size of the MultiSet is increased in
	 *         any case
	 */
	@Override
	 ...
	 *            the object to add
	 * @param occurrences
	 *            the number of occurrences to add, may be zero, in which case no
	 *            change is made to the multiset
	 * @return the number of occurrences of the object in the multiset before this
	 *         operation; possibly zero
	 * @throws IllegalArgumentException
	 ...
	 * <p>
	 * If the number of occurrences after this operations is reduced to zero, the
	 * object will be removed from the {@link #uniqueSet()}.
	 *
	 * @param object
	 ...
	 *            the object to remove
	 * @param occurrences
	 *            the number of occurrences to remove, may be zero, in which case no
	 *            change is made to the multiset
	 * @return the number of occurrences of the object in the multiset before the
	 *         operation; possibly zero
	 * @throws IllegalArgumentException
	 *             if occurrences is negative
	 */
	...
	/**
	 * Returns <code>true</code> if the MultiSet contains at least one occurrence
	...
	/**
	 * Remove all occurrences of all elements from this MultiSet represented in the
	 * given collection.
	 *
	 * @param coll
	...
	/**
	 * Remove any elements of this MultiSet that are not contained in the given
	 * collection.
	 *
	 * @param coll
	 ...
	 * <p>
	 * This MultiSet equals another object if it is also a MultiSet that contains
	...
	/**
	 * An unmodifiable entry for an element and its occurrence as contained in a
	 * MultiSet.
	 * <p>
	 * The {@link MultiSet#entrySet()} method returns a view of the multiset whose
	 * elements implements this interface.
	 *
	 * @param <E>
	 *            the element type
	 */
	interface Entry<E> {
		 ...
		 * the given object is also a multiset entry and the two entries represent the
		 * same element with the same number of occurrences.
		 * <p>
		 * More formally, two entries <tt>e1</tt> and <tt>e2</tt> represent the same
		 * mapping if
		 * 
		 * <pre>
		 * (e1.getElement() == null ? e2.getElement() == null : e1.getElement().equals(e2.getElement()))
		 * 		&amp;&amp; (e1.getCount() == e2.getCount())
		 * </pre>
		 *
		 * @param o
		 *            object to be compared for equality with this multiset entry
