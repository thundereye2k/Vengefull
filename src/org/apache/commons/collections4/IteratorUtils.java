...
public class IteratorUtils {
	...
	/**
	 * Default delimiter used to delimit elements while converting an Iterator to
	 ...
	 * <p>
	 * This iterator is a valid iterator object that will iterate over the specified
	 * object.
	 *
	 * @param <E>
	 *            the element type
	 ...
	 * <p>
	 * This iterator is a valid list iterator object that will iterate over the
	 * specified object.
	 *
	 * @param <E>
	 *            the element type
	 ...
	 * <p>
	 * This method will handle primitive arrays as well as object arrays. The
	 * primitives will be wrapped in the appropriate wrapper class.
	 *
	 * @param <E>
	 *            the element type
	 * @param array
	 ...
	 *             if start is less than zero or greater than the length of the
	 *             array
	 * @throws NullPointerException
	 *             if array is null
	 */
	 ...
	 * @return an iterator over part of the array
	 * @throws IllegalArgumentException
	 *             if the array is not an array or end is before start
	 * @throws IndexOutOfBoundsException
	 *             if array bounds are invalid
	 * @throws NullPointerException
	 *             if array is null
	...
	// -----------------------------------------------------------------------
	/**
	 * Decorates the specified iterator to return at most the given number of
	 * elements.
	 *
	 * @param <E>
	 *            the element type
	 ...
	 * @param max
	 *            the maximum number of elements returned by this iterator
	...
	/**
	 * Decorates the specified iterator to return at most the given number of
	 * elements, skipping all elements until the iterator reaches the position at
	 * {@code offset}.
	 * <p>
	 ...
	 *            the iterator to decorate
	 * @param offset
	 *            the index of the first element of the decorated iterator to return
	 * @param max
	 *            the maximum number of elements returned by this iterator
	 * @return a new bounded iterator
	 * @throws NullPointerException
	...
	// -----------------------------------------------------------------------
	/**
	 * Gets an immutable version of an {@link Iterator}. The returned object will
	 * always throw an {@link UnsupportedOperationException} for the
	...
	/**
	 * Gets an immutable version of a {@link ListIterator}. The returned object will
	 * always throw an {@link UnsupportedOperationException} for the
	 * {@link Iterator#remove}, {@link ListIterator#add} and
	...
	/**
	 * Gets an immutable version of a {@link MapIterator}. The returned object will
	 * always throw an {@link UnsupportedOperationException} for the
	...
	/**
	 * Gets an iterator that iterates through two {@link Iterator}s one after
	 * another.
	 *
	 * @param <E>
	 *            the element type
	...
	public static <E> Iterator<E> chainedIterator(final Iterator<? extends E> iterator1,
		...
		// keep a version with two iterators to avoid the following warning in client
		// code (Java 5 & 6)
	...
	/**
	 * Gets an iterator that iterates through an array of {@link Iterator}s one
	 * after another.
	 *
	 * @param <E>
	 *            the element type
	...
	/**
	 * Gets an iterator that iterates through a collections of {@link Iterator}s one
	 * after another.
	 *
	 * @param <E>
	 *            the element type
	 ...
	 * <p>
	 * Given two ordered {@link Iterator}s <code>A</code> and <code>B</code>, the
	 ...
	 *            the element type
	 * @param comparator
	 *            the comparator to use, may be null for natural order
	 * @param iterator1
	 ...
	 * graph. The iteration starts from a single root object. It uses a
	 * <code>Transformer</code> to extract the iterators and elements. Its main
	 * benefit is that no intermediate <code>ListCommand</code> is created.
	 * <p>
	 ...
	 * transformer is called to examine the object. The transformer will return
	 * either an iterator or an object. If the object is an Iterator, the next
	 * element from that iterator is obtained and the process repeats. If the
	 * element is an object it is returned.
	 * <p>
	 ...
	 *            the element type
	 * @param root
	 *            the root object to start iterating from, null results in an empty
	 *            iterator
	 * @param transformer
	 ...
	 *            the element type
	 * @param listIterator
	 *            the list iterator to use, not null
	 * @param predicate
	 *            the predicate to use as a filter, not null
	 * @return a new filtered iterator
	 * @throws NullPointerException
	 ...
	 * <p>
	 * The iterator will only stop looping if the remove method is called enough
	 * times to empty the collection, or if the collection is empty to start with.
	 *
	 * @param <E>
	 *            the element type
	 * @param coll
	...
	// -----------------------------------------------------------------------
	/**
	 * Gets an {@link Iterator} that wraps the specified {@link NodeList}. The
	 * returned {@link Iterator} can be used for a single iteration.
	 *
	 * @param nodeList
	...
	/**
	 * Gets an {@link Iterator} that wraps the specified node's childNodes. The
	 * returned {@link Iterator} can be used for a single iteration.
	 * <p>
	 ...
	 *            the element type
	 * @param a
	 *            the first iterator to interleave
	 * @param b
	 ...
	 *            the second iterator to interleave
	 * @param c
	 *            the third iterator to interleave
	 * @return an iterator, interleaving the decorated iterators
	 * @throws NullPointerException
	 *             if any iterator is null
	 * @since 4.1
	...
	/**
	 * Gets an iterator that provides an iterator view of the given enumeration that
	 * will remove elements from the specified collection.
	 *
	 * @param <E>
	 *            the element type
	 * @param enumeration
	...
	/**
	 * Gets an {@link Iterable} that wraps an iterator. The returned
	 * {@link Iterable} can be used for a single iteration.
	 *
	 * @param <E>
	 *            the element type
	 * @param iterator
	...
	/**
	 * Gets an iterable that wraps an iterator. The returned iterable can be used
	 ...
	 * <p>
	 * As the wrapped Iterator is traversed, a LinkedList of its values is cached,
	 ...
	 * @return the last element in the iterator, or null if iterator is null or
	 *         empty
	 * @throws NullPointerException
	 *             if closure is null
	 * @since 4.1
	 ...
	 * @return the first element of the iterator which matches the predicate or null
	...
	/**
	 * Returns the index of the first element in the specified iterator that matches
	 * the given predicate.
	 * <p>
	...
	public static <E> String toString(final Iterator<E> iterator, final Transformer<? super E, String> transformer) {
		return toString(iterator, transformer, DEFAULT_TOSTRING_DELIMITER, DEFAULT_TOSTRING_PREFIX,
