 ...
 * </ul>
 * <p>
 * Since v4.1 only factories which are considered to be unsafe are Serializable.
 * Factories considered to be unsafe for serialization are:
 * <ul>
 * <li>Prototype
 * <li>Instantiate
 * </ul>
...
public class FactoryUtils {
	...
	/**
	 * Gets a Factory that always throws an exception. This could be useful during
	...
	/**
	 * Gets a Factory that will return null each time the factory is used. This
	 * could be useful during testing as a placeholder.
	 *
	 * @see org.apache.commons.collections4.functors.ConstantFactory
	 * @param <T>
	 *            the "type" of null object the factory should return.
	 * @return the factory
	 */
	...
	/**
	 * Creates a Factory that will return the same object each time the factory is
	 * used. No check is made that the object is immutable. In general, only
	 * immutable objects should use the constant factory. Mutable objects should use
	...
	/**
	 * Creates a Factory that will return a clone of the same prototype object each
	 * time the factory is used. The prototype will be cloned using one of these
	 * techniques (in order):
	 * <ul>
	 ...
	 * @return the <code>prototype</code> factory, or a
	 *         {@link ConstantFactory#NULL_INSTANCE} if the {@code prototype} is
	 *         {@code null}
	...
	/**
	 * Creates a Factory that can create objects of a specific type using a no-args
	 * constructor.
	 *
	...
	/**
	 * Creates a Factory that can create objects of a specific type using the
	 * arguments specified to this method.
	 *
	 * @see org.apache.commons.collections4.functors.InstantiateFactory
	 *
	 * @param <T>
	 ...
	 * @throws IllegalArgumentException
	 *             if the constructor doesn't exist
	 */
