 ...
 * underlying ListCommand of Comparators or the BitSet that defines the sort order.
 * <p>
...
public class ComparatorChain<E> implements Comparator<E>, Serializable {
	...
	// -----------------------------------------------------------------------
	/**
	 * Construct a ComparatorChain with no Comparators. You must add at least one
	 * Comparator before calling the compare(Object,Object) method, or an
	...
	/**
	 * Construct a ComparatorChain with a single Comparator, sorting in the forward
	 * order
	 *
	 * @param comparator
	...
	/**
	 * Construct a Comparator chain with a single Comparator, sorting in the given
	 * order
	 *
	 * @param comparator
	...
	/**
	 * Construct a ComparatorChain from the Comparators in the ListCommand. All Comparators
	 * will default to the forward sort order.
	 *
	 * @param list
	 *            ListCommand of Comparators
	 * @see #ComparatorChain(ListCommand,BitSet)
	 */
	...
	/**
	 * Construct a ComparatorChain from the Comparators in the given ListCommand. The sort
	 * order of each column will be drawn from the given BitSet. When determining
	 * the sort order for Comparator at index <i>i</i> in the ListCommand, the
	 * ComparatorChain will call BitSet.get(<i>i</i>). If that method returns
	 * <i>false</i>, the forward sort order is used; a return value of <i>true</i>
	 * indicates reverse sort order.
	 *
	 * @param list
	 *            ListCommand of Comparators. NOTE: This constructor does not perform a
	 *            defensive copy of the list
	 * @param bits
	 *            Sort order for each Comparator. Extra bits are ignored, unless
	 *            extra Comparators are added by another method.
	 */
	...
	/**
	 * Replace the Comparator at the given index in the ComparatorChain, using the
	 * given sort order
	 *
	 * @param index
	 *            index of the Comparator to replace
	...
	/**
	 * Change the sort order at the given index in the ComparatorChain to a forward
	 * sort.
	 *
	 * @param index
	...
	/**
	 * Change the sort order at the given index in the ComparatorChain to a reverse
	 * sort.
	 *
	 * @param index
	 *            Index of the ComparatorChain
	...
	/**
	 * Returns <code>true</code> iff <i>that</i> Object is is a {@link Comparator}
	 * whose ordering is known to be equivalent to mine.
	 * <p>
	 * This implementation returns <code>true</code> iff
	 * <code><i>object</i>.{@link Object#getClass() getClass()}</code> equals
	 * <code>this.getClass()</code>, and the underlying comparators and order bits
	 * are equal. Subclasses may want to override this behavior to remain consistent
