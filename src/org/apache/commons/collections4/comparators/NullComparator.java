...
/**
 * A Comparator that will compare nulls to be either lower or higher than other
 * objects.
 *
 * @since 2.0
...
public class NullComparator<E> implements Comparator<E>, Serializable {
	 ...
	 * non-<code>null</code> objects, the {@link ComparableComparator} is used.
	 **/
	 ...
	 * Construct an instance that sorts <code>null</code> higher than any
	 * non-<code>null</code> object it is compared with. When comparing two
	 * non-<code>null</code> objects, the specified {@link Comparator} is used.
	 *
	 * @param nonNullComparator
	 *            the comparator to use when comparing two non-<code>null</code>
	 *            objects. This argument cannot be <code>null</code>
	 *
	 * @exception NullPointerException
	 *                if <code>nonNullComparator</code> is <code>null</code>
	 **/
	...
	/**
	 * Construct an instance that sorts <code>null</code> higher or lower than any
	 * non-<code>null</code> object it is compared with. When comparing two
	 * non-<code>null</code> objects, the {@link ComparableComparator} is used.
	 *
	 * @param nullsAreHigh
	 *            a <code>true</code> value indicates that <code>null</code> should
	 *            be compared as higher than a non-<code>null</code> object. A
	 *            <code>false</code> value indicates that <code>null</code> should
	 *            be compared as lower than a non-<code>null</code> object.
	 **/
	@SuppressWarnings("unchecked")
	 ...
	 * <code>null</code> and the other is not, the result is determined on whether
	 * the Comparator was constructed to have nulls as higher or lower than other
	 * objects. If neither object is <code>null</code>, an underlying comparator
	 * specified in the constructor (or the default) is used to compare the
	 * non-<code>null</code> objects.
	 *
	 * @param o1
	...
	/**
	 * Determines whether the specified object represents a comparator that is equal
	 * to this comparator.
	 *
	 * @param obj
	 *            the object to compare this comparator with.
	 *
	 * @return <code>true</code> if the specified object is a NullComparator with
	 *         equivalent <code>null</code> comparison behavior (i.e.
	 *         <code>null</code> high or low) and with equivalent underlying
