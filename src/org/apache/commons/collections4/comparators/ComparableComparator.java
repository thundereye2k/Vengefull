...
public class ComparableComparator<E extends Comparable<? super E>> implements Comparator<E>, Serializable {
	...
	// -----------------------------------------------------------------------
	/**
	 * Compare the two {@link Comparable Comparable} arguments. This method is
	 * equivalent to:
	 * 
	 * <pre>
	 ...
	 *             if <i>obj1</i> is <code>null</code>, or when
	 *             <code>((Comparable)obj1).compareTo(obj2)</code> does
	 * @throws ClassCastException
	 *             if <i>obj1</i> is not a <code>Comparable</code>, or when
	 *             <code>((Comparable)obj1).compareTo(obj2)</code> does
	 */
	@Override
	...
	/**
	 * Returns {@code true} iff <i>that</i> Object is is a {@link Comparator
	 ...
	 * <code>this.getClass()</code>. Subclasses may want to override this behavior
	 * to remain consistent with the {@link Comparator#equals(Object)} contract.
	 *
	 * @param object
