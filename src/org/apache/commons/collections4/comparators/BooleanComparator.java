...
public final class BooleanComparator implements Comparator<Boolean>, Serializable {
	...
	/**
	 * <code>true</code> iff <code>true</code> values sort before <code>false</code>
	 * values.
	 */
	...
	// -----------------------------------------------------------------------
	/**
	 * Returns a BooleanComparator instance that sorts <code>true</code> values
	 * before <code>false</code> values.
	 * <p />
	 * Clients are encouraged to use the value returned from this method instead of
	 * constructing a new instance to reduce allocation and garbage collection
	 * overhead when multiple BooleanComparators may be used in the same virtual
	 * machine.
	 *
	...
	/**
	 * Returns a BooleanComparator instance that sorts <code>false</code> values
	 * before <code>true</code> values.
	 * <p />
	 * Clients are encouraged to use the value returned from this method instead of
	 * constructing a new instance to reduce allocation and garbage collection
	 * overhead when multiple BooleanComparators may be used in the same virtual
	...
	/**
	 * Returns a BooleanComparator instance that sorts <code><i>trueFirst</i></code>
	 * values before <code>&#x21;<i>trueFirst</i></code> values.
	 * <p />
	 * Clients are encouraged to use the value returned from this method instead of
	 * constructing a new instance to reduce allocation and garbage collection
	 * overhead when multiple BooleanComparators may be used in the same virtual
	 ...
	 *
	 * @param trueFirst
	 *            when <code>true</code>, sort <code>true</code>
	 *            <code>Boolean</code>s before <code>false</code>
	...
	// -----------------------------------------------------------------------
	/**
	 * Creates a <code>BooleanComparator</code> that sorts <code>false</code> values
	 * before <code>true</code> values.
	 * <p>
	 ...
	 *
	 * @param trueFirst
	 *            when <code>true</code>, sort <code>true</code> boolean values
	 *            before <code>false</code>
	 */
	...
	// -----------------------------------------------------------------------
	/**
	 * Compares two non-<code>null</code> <code>Boolean</code> objects according to
	 * the value of {@link #sortsTrueFirst()}.
	 *
	 * @param b1
	 ...
	 * <p>
	 * This implementation returns <code>true</code> iff <code><i>that</i></code> is
	 * a {@link BooleanComparator} whose value of {@link #sortsTrueFirst()} is equal
	 * to mine.
	 *
	 * @param object
	...
	public boolean equals(final Object object) {
		return (this == object) || ((object instanceof BooleanComparator)
				&& (this.trueFirst == ((BooleanComparator) object).trueFirst));
	}

	// -----------------------------------------------------------------------
	/**
	 * Returns <code>true</code> iff I sort <code>true</code> values before
	 * <code>false</code> values. In other words, returns <code>true</code> iff
	 * {@link #compare(Boolean,Boolean) compare(Boolean.FALSE,Boolean.TRUE)} returns
	 * a positive value.
	 *
