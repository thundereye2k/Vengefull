...
public class ReverseComparator<E> implements Comparator<E>, Serializable {
	 ...
	 * natural ordering. Using this Constructor will create a ReverseComparator that
	 * is functionally identical to the Comparator returned by
	...
	/**
	 * Creates a comparator that inverts the comparison of the given comparator. If
	 * you pass in <code>null</code>, the ReverseComparator defaults to reversing
	 * the natural order, as per {@link java.util.Collections#reverseOrder()}.
	 *
	 * @param comparator
	 ...
	 * Subclasses may want to override this behavior to remain consistent with the
	 * {@link Comparator#equals(Object) equals} contract.
	 *
	 * @param object
