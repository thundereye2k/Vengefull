 ...
 * retains both keys and values in sorted order.
 * <p>
...
public interface SortedBidiMap<K, V> extends OrderedBidiMap<K, V>, SortedMap<K, V> {
	 ...
	 * <p>
	 * Implementations must return a <code>SortedBidiMap</code> instance, usually by
	 * forwarding to <code>inverseSortedBidiMap()</code>.
	 *
