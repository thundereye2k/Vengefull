...
/**
 * Implementation of <code>BidiMap</code> that uses two
 * <code>LinkedHashMap</code> instances.
 * <p>
 * Two <code>LinkedHashMap</code> instances are used in this class. This
 * provides fast lookups at the expense of storing two sets of map entries and
 * two linked lists.
 *
...
public class DualLinkedHashBidiMap<K, V> extends AbstractDualBidiMap<K, V> implements Serializable {
	...
	/**
	 * Constructs a <code>LinkedHashBidiMap</code> that decorates the specified
	 * maps.
	 *
	 * @param normalMap
