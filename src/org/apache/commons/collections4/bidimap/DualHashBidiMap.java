 ...
 * <p>
 * Two {@link HashMap} instances are used in this class. This provides fast
...
public class DualHashBidiMap<K, V> extends AbstractDualBidiMap<K, V> implements Serializable {
	...
	/**
	 * Constructs a <code>HashBidiMap</code> and copies the mappings from specified
	 * <code>Map</code>.
	 *
	 * @param map
