...
public class QueueUtils {
	 ...
	 * queue. Trying to add an invalid object results in an
	 * IllegalArgumentException. It is important not to use the original queue after
	 * invoking this method, as it is a backdoor for adding invalid objects.
	 *
	 * @param <E>
	 *            the type of the elements in the queue
	 * @param queue
	 *            the queue to predicate, must not be null
	 * @param predicate
	 ...
	 * <p>
	 * Each object is passed through the transformer as it is added to the Queue. It
	 * is important not to use the original queue after invoking this method, as it
	 * is a backdoor for adding untransformed objects.
	 * <p>
	 * Existing entries in the specified queue will not be transformed. If you want
	 * that behaviour, see {@link TransformedQueue#transformedQueue}.
	 *
	 * @param <E>
	 *            the type of the elements in the queue
	 * @param queue
