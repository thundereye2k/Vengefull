 ...
 * whether a predicate evaluates as true or false.
 *
 * @param <I>
...
public class IfTransformer<I, O> implements Transformer<I, O>, Serializable {
	...
	/**
	 * Constructor that performs no validation. Use the static factory method
	 * <code>ifTransformer</code> if you want that.
	 *
	 * @param predicate
	...
	/**
	 * Transforms the input using the true or false transformer based to the result
	 * of the predicate.
	 *
	 * @param input
