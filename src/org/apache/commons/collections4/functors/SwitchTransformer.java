...
public class SwitchTransformer<I, O> implements Transformer<I, O>, Serializable {
	 ...
	 * @param transformers
	 *            matching array of transformers, cloned, no nulls
	 ...
	 * key. The ordering is that of the iterator() method on the entryset collection
	 * of the map.
	 *
	 * @param <I>
	 *            the input type
	...
	public static <I, O> Transformer<I, O> switchTransformer(
		...
		int i = 0;
		for (final Map.Entry<? extends Predicate<? super I>, ? extends Transformer<? super I, ? extends O>> entry : map
				.entrySet()) {
	...
	/**
	 * Constructor that performs no validation. Use <code>switchTransformer</code>
	 * if you want that.
	 *
	 * @param predicates
	 *            array of predicates, cloned, no nulls
