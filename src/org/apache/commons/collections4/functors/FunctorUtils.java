...
class FunctorUtils {
	 ...
	 * with. Due to the {@link Predicate#evaluate(T)} method, Predicate<? super T>
	 * is able to be coerced to Predicate<T> without casting issues.
	 *
	 * @param predicates
	...
	/**
	 * A very simple method that coerces Predicate<? super T> to Predicate<T>. Due
	 * to the {@link Predicate#evaluate(T)} method, Predicate<? super T> is able to
	 * be coerced to Predicate<T> without casting issues.
	 * <p>
	 * This method exists simply as centralised documentation and atomic unchecked
	 * warning suppression.
	 *
	 * @param <T>
	...
	/**
	 * Clone the closures to ensure that the internal reference can't be messed
	 * with.
	 *
	 * @param closures
	...
	/**
	 * A very simple method that coerces Transformer<? super I, ? extends O> to
	 * Transformer<I, O>.
	 * <p>
	 * This method exists simply as centralised documentation and atomic unchecked
	 * warning suppression.
