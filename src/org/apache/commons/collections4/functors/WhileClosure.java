...
/**
 * Closure implementation that executes a closure repeatedly until a condition
 * is met, like a do-while or while loop.
 * <p>
 * <b>WARNING:</b> from v4.1 onwards this class will <b>not</b> be serializable
 * anymore in order to prevent potential remote code execution exploits. Please
 * refer to <a href=
...
public class WhileClosure<E> implements Closure<E> {
	...
	/**
	 * Constructor that performs no validation. Use <code>whileClosure</code> if you
	 * want that.
	 *
	 * @param predicate
	 *            the predicate used to evaluate when the loop terminates, not null
