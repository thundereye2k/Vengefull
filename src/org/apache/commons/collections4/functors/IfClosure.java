...
public class IfClosure<E> implements Closure<E>, Serializable {
	 ...
	 * <p>
	 * This factory creates a closure that performs no action when the predicate is
	 * false.
	 *
	 * @param <E>
	...
	/**
	 * Constructor that performs no validation. Use <code>ifClosure</code> if you
	 * want that.
	 * <p>
	 * This constructor creates a closure that performs no action when the predicate
	 * is false.
	 *
	 * @param predicate
