...
/**
 * Predicate implementation that returns true if any of the predicates return
 * true. If the array of predicates is empty, then this predicate returns false.
 * <p>
 * NOTE: In versions prior to 3.2 an array size of zero or one threw an
 * exception.
 *
 * @since 3.0
...
public final class AnyPredicate<T> extends AbstractQuantifierPredicate<T> {
	 ...
	 * <p>
	 * If the array is size zero, the predicate always returns false. If the array
	 * is size one, then that predicate is returned.
	 *
	 * @param <T>
	 ...
	 * Factory to create the predicate.
	 * <p>
	 * If the collection is size zero, the predicate always returns false. If the
	 * collection is size one, then that predicate is returned.
	 *
	 * @param <T>
	 *            the type that the predicate queries
	 * @param predicates
	...
	/**
	 * Constructor that performs no validation. Use <code>anyPredicate</code> if you
	 * want that.
	 *
	 * @param predicates
