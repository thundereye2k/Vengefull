...
/**
 * Factory implementation that creates a new instance each time based on a
 * prototype.
 * <p>
 * <b>WARNING:</b> from v4.1 onwards {@link Factory} instances returned by
 * {@link #prototypeFactory(Object)} will <b>not</b> be serializable anymore in
 * order to prevent potential remote code execution exploits. Please refer to
 * <a href=
 * "https://issues.apache.org/jira/browse/COLLECTIONS-580">COLLECTIONS-580</a>
 * for more details.
 *
 * @since 3.0
...
public class PrototypeFactory {
	...
	public static <T> Factory<T> prototypeFactory(final T prototype) {
		...
		try {
			...
			try {
				...
				return new InstantiateFactory<T>((Class<T>) prototype.getClass(),
	...
	// -----------------------------------------------------------------------
	/**
	 * PrototypeCloneFactory creates objects by copying a prototype using the clone
	 * method.
	 */
	...
	// -----------------------------------------------------------------------
	/**
	 * PrototypeSerializationFactory creates objects by cloning a prototype using
	 * serialization.
	 */
