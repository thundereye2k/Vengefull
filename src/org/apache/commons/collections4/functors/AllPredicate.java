...
public final class AllPredicate<T> extends AbstractQuantifierPredicate<T> {
	 ...
	 * <p>
	 * If the array is size zero, the predicate always returns true. If the array is
	 ...
	 * Factory to create the predicate.
	 * <p>
	 * If the collection is size zero, the predicate always returns true. If the
	...
	/**
	 * Constructor that performs no validation. Use <code>allPredicate</code> if you
	 * want that.
	 *
	 * @param predicates
