...
/**
 * Predicate implementation that returns true if only one of the predicates
 * return true. If the array of predicates is empty, then this predicate returns
 * false.
 * <p>
...
public final class OnePredicate<T> extends AbstractQuantifierPredicate<T> {
	...
	/**
	 * Constructor that performs no validation. Use <code>onePredicate</code> if you
	 * want that.
	 *
	 * @param predicates
