...
/**
 * Predicate implementation that returns true if the input is the same object as
 * the one stored in this predicate by equals.
 *
 * @since 3.0
...
public final class EqualPredicate<T> implements Predicate<T>, Serializable {
	...
	/**
	 * Constructor that performs no validation. Use <code>equalPredicate</code> if
	 * you want that.
	 *
	 * @param object
	 *            the object to compare to
