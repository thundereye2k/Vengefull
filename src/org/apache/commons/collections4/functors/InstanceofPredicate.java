...
/**
 * Predicate implementation that returns true if the input is an instanceof the
 * type stored in this predicate.
 *
 * @since 3.0
...
public final class InstanceofPredicate implements Predicate<Object>, Serializable {
	...
	/**
	 * Constructor that performs no validation. Use <code>instanceOfPredicate</code>
	 * if you want that.
	 *
	 * @param type
