...
/**
 * Predicate implementation that returns true if none of the predicates return
 * true. If the array of predicates is empty, then this predicate returns true.
 * <p>
...
public final class NonePredicate<T> extends AbstractQuantifierPredicate<T> {
	...
	/**
	 * Constructor that performs no validation. Use <code>nonePredicate</code> if
	 * you want that.
	 *
	 * @param predicates
