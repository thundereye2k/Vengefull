...
public class InvokerTransformer<I, O> implements Transformer<I, O> {
	...
	/**
	 * Constructor that performs no validation. Use <code>invokerTransformer</code>
	 * if you want that.
	 * <p>
	...
	public O transform(final Object input) {
		...
		try {
			...
			throw new FunctorException("InvokerTransformer: The method '" + iMethodName + "' on '" + input.getClass()
					+ "' does not exist");
