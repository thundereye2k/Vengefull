 ...
 * <p>
 * The add/offer methods are affected by this class. Thus objects must be
...
public class TransformedQueue<E> extends TransformedCollection<E> implements Queue<E> {
	 ...
	 * <p>
	 * If there are any elements already in the queue being decorated, they are NOT
	 * transformed. Contrast this with
	 * {@link #transformedQueue(Queue, Transformer)}.
	 *
	 * @param <E>
	 ...
	 *             if queue or transformer is null
	 */
	...
	/**
	 * Factory method to create a transforming queue that will transform existing
	 * contents of the specified queue.
	 * <p>
	 * If there are any elements already in the queue being decorated, they will be
	 * transformed by this method. Contrast this with
	 * {@link #transformingQueue(Queue, Transformer)}.
	 *
	 * @param <E>
	 *            the type of the elements in the queue
	 * @param queue
