...
/**
 * Decorates another {@link Queue} to validate that additions match a specified
 * predicate.
 * <p>
 * This queue exists to provide validation for the decorated queue. It is
 * normally created to decorate an empty queue. If an object cannot be added to
 * the queue, an IllegalArgumentException is thrown.
 * <p>
...
public class PredicatedQueue<E> extends PredicatedCollection<E> implements Queue<E> {
	 ...
	 * <p>
	 * If there are any elements already in the queue being decorated, they are
	 * validated.
	 *
	 * @param <E>
