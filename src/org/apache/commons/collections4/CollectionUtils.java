 ...
 * case the input objects override {@link Object#equals(Object)}, it is
...
public class CollectionUtils {
	...
	/**
	 * An empty unmodifiable collection. The JDK provides empty Set and ListCommand
	 * implementations which could be used for this purpose. However they could be
	 * cast to Set or ListCommand which might be undesirable. This implementation only
	 * implements Collection.
	 */
	@SuppressWarnings("rawtypes") // we deliberately use the raw type here
	public static final Collection EMPTY_COLLECTION = UnmodifiableCollection
			.unmodifiableCollection(new ArrayList<Object>());
	 ...
	 * @param <O>
	 *            the generic type that is able to represent the types contained in
	 ...
	 * <i>b</i>. Only the elements of <i>b</i> that satisfy the predicate condition,
	 * <i>p</i> are subtracted from <i>a</i>.
	 *
	 * <p>
	 * The cardinality of each element <i>e</i> in the returned {@link Collection}
	 * that satisfies the predicate condition will be the cardinality of <i>e</i> in
	 * <i>a</i> minus the cardinality of <i>e</i> in <i>b</i>, or zero, whichever is
	 * greater.
	 * </p>
	 * <p>
	 * The cardinality of each element <i>e</i> in the returned {@link Collection}
	 * that does <b>not</b> satisfy the predicate condition will be equal to the
	 * cardinality of <i>e</i> in <i>a</i>.
	 * </p>
	 *
	 * @param a
	 *            the collection to subtract from, must not be null
	 ...
	 * Providing incompatible arguments (e.g. by casting to their rawtypes) will
	 * result in a {@code ClassCastException} thrown at runtime.
	 *
	 * @param <E>
	 *            the element type
	 * @param a
	 ...
	 * @param <O>
	 *            the type of object that the {@link Iterable} may contain.
	 * @return the the number of occurrences of obj in coll
	 * @throws NullPointerException
	 *             if coll is null
	 * @deprecated since 4.1, use {@link IterableUtils#frequency(Iterable, Object)}
	 *             instead. Be aware that the order of parameters has changed.
	 */
	@Deprecated
	 ...
	 * @deprecated since 4.1, use {@link IterableUtils#find(Iterable, Predicate)}
	 *             instead
	 */
	@Deprecated
	 ...
	 * @return closure
	 * @deprecated since 4.1, use {@link IterableUtils#forEach(Iterable, Closure)}
	 *             instead
	 */
	@Deprecated
	 ...
	 * @return closure
	 * @since 4.0
	 * @deprecated since 4.1, use {@link IteratorUtils#forEach(Iterator, Closure)}
	 *             instead
	 */
	@Deprecated
	 ...
	 * @param closure
	 *            the closure to perform, may be null
	 * @return the last element in the collection, or null if either collection or
	 *         closure is null
	 * @since 4.0
	 * @deprecated since 4.1, use
	 *             {@link IterableUtils#forEachButLast(Iterable, Closure)} instead
	 */
	@Deprecated
	 ...
	 * @param closure
	 *            the closure to perform, may be null
	 * @return the last element in the collection, or null if either iterator or
	 *         closure is null
	 * @since 4.0
	 * @deprecated since 4.1, use
	 *             {@link IteratorUtils#forEachButLast(Iterator, Closure)} instead
	 */
	@Deprecated
	 ...
	 * reduce in size due to calling this method.
	 *
	 * @param <C>
	 *            the type of object the {@link Collection} contains
	 * @param collection
	 ...
	 * @deprecated since 4.1, use
	 *             {@link IterableUtils#countMatches(Iterable, Predicate)} instead
	 */
	@Deprecated
	 ...
	 * @deprecated since 4.1, use
	 *             {@link IterableUtils#matchesAny(Iterable, Predicate)} instead
	 */
	@Deprecated
	 ...
	 * @since 4.0
	 * @deprecated since 4.1, use
	 *             {@link IterableUtils#matchesAll(Iterable, Predicate)} instead
	 */
	@Deprecated
	 ...
	 *            the collection to output into, may not be null if the
	 *            inputCollection and predicate or not null
	 ...
	 * <code>outputCollection</code>, all other elements are added to the
	 * <code>rejectedCollection</code>.
	 * <p>
	 ...
	 *            the predicate to use, may be null
	 * @param outputCollection
	 *            the collection to output selected elements into, may not be null
	 *            if the inputCollection and predicate are not null
	 * @param rejectedCollection
	 *            the collection to output rejected elements into, may not be null
	 *            if the inputCollection or predicate are not null
	 * @return the outputCollection
	 * @since 4.1
	 */
	public static <O, R extends Collection<? super O>> R select(final Iterable<? extends O> inputCollection,
	 ...
	 * <code>index</code> exceeds the number of entries) as a side effect of this
	 * method.
	 *
	 * @param iterator
	 ...
	 * such an entry.</li>
	 * <li>ListCommand -- this method is equivalent to the list's get method.</li>
	 ...
	 * @throws IllegalArgumentException
	 *             thrown if object is not recognised
	 * @since 3.1
	 */
	...
	// -----------------------------------------------------------------------
	/**
	 * Merges two sorted Collections, a and b, into a single, sorted ListCommand such that
	 ...
	 * @param b
	 *            the second collection, must not be null
	 * @return a new sorted ListCommand, containing the elements of Collection a and b
	 * @throws NullPointerException
	 ...
	 *            if {@code true} duplicate elements will be retained, otherwise
	 ...
	 * @return a new sorted ListCommand, containing the elements of Collection a and b
	 * @throws NullPointerException
	 *             if either collection or the comparator is null
	 * @since 4.0
	 */
	...
	public static <O> List<O> collate(final Iterable<? extends O> a, final Iterable<? extends O> b,
		...
		final int totalSize = a instanceof Collection<?> && b instanceof Collection<?>
				? Math.max(1, ((Collection<?>) a).size() + ((Collection<?>) b).size())
				: 10;
	 ...
	 * {@link Object#equals(Object)} to determine the equality of the elements in
	 * <code>collection</code> and <code>retain</code>. Hence this method is useful
	 * in cases where the equals behavior of an object needs to be modified without
	 * changing the object itself.
	 *
	 * @param <E>
	 *            the type of object the {@link Collection} contains
	 * @param collection
	 *            the collection whose contents are the target of the
	 ...
	 * @return a <code>Collection</code> containing all the elements of
	 *         <code>collection</code> that occur at least once in
	 *         <code>retain</code> according to the <code>equator</code>
	 * @throws NullPointerException
	 *             if any of the parameters is null
	 * @since 4.1
	 */
	public static <E> Collection<E> retainAll(final Iterable<E> collection, final Iterable<? extends E> retain,
			final Equator<? super E> equator) {
	 ...
	 * That is, this method returns a collection containing all the elements in
	 * <code>collection</code> that are not in <code>remove</code>. The cardinality
	 * of an element <code>e</code> in the returned collection is the same as the
	 * cardinality of <code>e</code> in <code>collection</code> unless
	 * <code>remove</code> contains <code>e</code>, in which case the cardinality is
	 * zero. This method is useful if you do not wish to modify the collection
	 * <code>c</code> and thus cannot call
	 ...
	 * Moreover this method uses an {@link Equator} instead of
	 * {@link Object#equals(Object)} to determine the equality of the elements in
	 * <code>collection</code> and <code>remove</code>. Hence this method is useful
	 * in cases where the equals behavior of an object needs to be modified without
	 * changing the object itself.
	 *
	 * @param <E>
	 ...
	 *            the Equator used for testing equality
	 * @return a <code>Collection</code> containing all the elements of
	 *         <code>collection</code> except any element that if equal according to
	 *         the <code>equator</code>
	 * @throws NullPointerException
	 *             if any of the parameters is null
	 * @since 4.1
	 */
	public static <E> Collection<E> removeAll(final Iterable<E> collection, final Iterable<? extends E> remove,
			final Equator<? super E> equator) {
	 ...
	 * <p>
	 * Only objects that pass the test in the given predicate can be added to the
	 * collection. Trying to add an invalid object results in an
	 * IllegalArgumentException. It is important not to use the original collection
	 * after invoking this method, as it is a backdoor for adding invalid objects.
	 *
	 * @param <C>
	 ...
	 * this method, as it is a backdoor for adding untransformed objects.
	 * <p>
	 * Existing entries in the specified collection will not be transformed. If you
	 * want that behaviour, see {@link TransformedCollection#transformedCollection}.
	 *
	 * @param <E>
	 *            the type of object the {@link Collection} contains
	 * @param collection
