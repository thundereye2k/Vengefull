 ...
 * garbage collector and matches keys and values based on <code>==</code> not
 * <code>equals()</code>.
 * <p>
 * <p>
 ...
 * {@link Reference}.
 * <p>
 * Different types of references can be specified for keys and values. The
 * default constructor uses hard keys and soft values, providing a
 * memory-sensitive cache.
 * <p>
 * This map is similar to
 * {@link org.apache.commons.collections4.map.ReferenceMap ReferenceMap}. It
 * differs in that keys and values in this class are compared using
 * <code>==</code>.
 * <p>
 ...
 * to a <code>ReferenceIdentityMap</code>. Remember that synchronization will
 * not stop the garbage collector removing entries.
 * <p>
 * All the available iterators can be reset back to the start by casting to
 * <code>ResettableIterator</code> and calling <code>reset()</code>.
 * <p>
 * <strong>Note that ReferenceIdentityMap is not synchronized and is not
 * thread-safe.</strong> If you wish to use this map from multiple threads
 * concurrently, you must use appropriate synchronization. The simplest approach
 * is to wrap this map using {@link java.util.Collections#synchronizedMap}. This
 * class may throw exceptions when accessed by concurrent threads without
 * synchronization.
 *
...
public class ReferenceIdentityMap<K, V> extends AbstractReferenceMap<K, V> implements Serializable {
	...
	/**
	 * Constructs a new <code>ReferenceIdentityMap</code> that will use hard
	 * references to keys and soft references to values.
	 */
	...
	/**
	 * Constructs a new <code>ReferenceIdentityMap</code> that will use the
	 * specified types of references.
	 *
	 * @param keyType
	 *            the type of reference to use for keys; must be
	 *            {@link AbstractReferenceMap.ReferenceStrength#HARD HARD},
	...
	/**
	 * Constructs a new <code>ReferenceIdentityMap</code> with the specified
	 * reference types, load factor and initial capacity.
	 *
	 * @param keyType
	 *            the type of reference to use for keys; must be
	 *            {@link AbstractReferenceMap.ReferenceStrength#HARD HARD},
	 ...
	 */
	public ReferenceIdentityMap(final ReferenceStrength keyType, final ReferenceStrength valueType, final int capacity,
