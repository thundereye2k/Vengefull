 ...
 * <p>
 * The Map API is very difficult to decorate correctly, and involves
 * implementing lots of different classes. This class exists to provide a
 * simpler API.
 * <p>
 * Special hook methods are provided that are called when objects are added to
 * the map. By overriding these methods, the input can be validated or
 * manipulated. In addition to the main map methods, the entrySet is also
 ...
 *
 * @since 3.1
 * @version $Id: AbstractInputCheckedMapDecorator.java 1686855 2015-06-22
 *          13:00:27Z tn $
 */
abstract class AbstractInputCheckedMapDecorator<K, V> extends AbstractMapDecorator<K, V> {
	 ...
	 * <p>
	 * An implementation may validate the value and throw an exception or it may
	 * transform the value into another object.
	 * <p>
	 ...
	 *             if the map may not be changed by setValue
	 * @throws IllegalArgumentException
	 *             if the specified value is invalid
	 * @throws ClassCastException
	 *             if the class of the specified value is invalid
	 * @throws NullPointerException
	 ...
	 * <p>
	 * An implementation should return false if the <code>checkSetValue</code>
	 * method has no effect as this optimises the implementation.
	 * <p>
