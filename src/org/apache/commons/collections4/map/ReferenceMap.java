 ...
 * {@link java.lang.ref.Reference Reference}.
 * <p>
 ...
 * ReferenceIdentityMap}. It differs in that keys and values in this class are
 ...
 * the garbage collector removing entries.
 * <p>
 * All the available iterators can be reset back to the start by casting to
 * <code>ResettableIterator</code> and calling <code>reset()</code>.
 * <p>
 * <strong>Note that ReferenceMap is not synchronized and is not
...
public class ReferenceMap<K, V> extends AbstractReferenceMap<K, V> implements Serializable {
	...
	/**
	 * Constructs a new <code>ReferenceMap</code> that will use hard references to
	 * keys and soft references to values.
	 */
	public ReferenceMap() {
	...
	/**
	 * Constructs a new <code>ReferenceMap</code> that will use the specified types
	 * of references.
	 *
	 * @param keyType
