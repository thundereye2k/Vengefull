...
/**
 * Decorates another <code>Map</code> to validate that additions match a
 * specified predicate.
 * <p>
 * This map exists to provide validation for the decorated map. It is normally
 * created to decorate an empty map. If an object cannot be added to the map, an
 ...
 * </pre>
 * <p>
 * <strong>Note that PredicatedMap is not synchronized and is not
...
public class PredicatedMap<K, V> extends AbstractInputCheckedMapDecorator<K, V> implements Serializable {
	 ...
	 * <p>
	 * If there are any elements already in the list being decorated, they are
	 * validated.
	 *
	 * @param <K>
	 *            the key type
	 ...
	 * @param keyPredicate
	 *            the predicate to validate the keys, null means no check
	 ...
	 * @since 4.0
	 */
	public static <K, V> PredicatedMap<K, V> predicatedMap(final Map<K, V> map, final Predicate<? super K> keyPredicate,
