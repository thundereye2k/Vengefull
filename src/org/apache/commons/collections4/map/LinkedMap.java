 ...
 * functionality, additional convenience methods and allowing bidirectional
 * iteration. It also implements <code>OrderedMap</code>. In addition,
 ...
 * methods exposed.
 * <p>
 * <strong>Note that LinkedMap is not synchronized and is not
...
public class LinkedMap<K, V> extends AbstractLinkedMap<K, V> implements Serializable, Cloneable {
	...
	/**
	 * Gets an unmodifiable ListCommand view of the keys.
	 * <p>
