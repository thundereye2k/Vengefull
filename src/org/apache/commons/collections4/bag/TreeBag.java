 ...
 * collection together with a count of occurrences. Extra methods on the
 * interface allow multiple copies of an object to be added or removed at once.
 * It is important to read the interface javadoc carefully as several methods
 * violate the {@link Collection} interface specification.
 *
...
public class TreeBag<E> extends AbstractMapBag<E> implements SortedBag<E>, Serializable {
	...
	/**
	 * Constructs a {@link TreeBag} containing all the members of the specified
	 * collection.
	 *
	 * @param coll
	 ...
	 *             if the object to be added does not implement {@link Comparable}
	 *             and the {@link TreeBag} is using natural ordering
	 * @throws NullPointerException
	 *             if the specified key is null and this bag uses natural ordering,
