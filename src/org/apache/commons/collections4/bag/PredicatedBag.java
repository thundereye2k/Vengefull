...
/**
 * Decorates another {@link Bag} to validate that additions match a specified
 * predicate.
 * <p>
 * This bag exists to provide validation for the decorated bag. It is normally
 * created to decorate an empty bag. If an object cannot be added to the bag, an
...
public class PredicatedBag<E> extends PredicatedCollection<E> implements Bag<E> {
	 ...
	 * <p>
	 * If there are any elements already in the bag being decorated, they are
	 * validated.
	 *
	 * @param <E>
