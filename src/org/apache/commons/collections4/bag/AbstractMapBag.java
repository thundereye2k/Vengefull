...
public abstract class AbstractMapBag<E> implements Bag<E> {
	...
	/**
	 * Constructor that assigns the specified Map as the backing store. The map must
	 * be empty and non-null.
	 *
	 * @param map
	 *            the map to assign
	 */
	...
	/**
	 * Utility method for implementations to access the map that backs this bag. Not
	 * intended for interactive use outside of subclasses.
	 *
	...
	/**
	 * Returns the number of occurrence of the given element in this bag by looking
	 * up its count in the underlying map.
	 *
	 * @param object
	...
	// -----------------------------------------------------------------------
	/**
	 * Gets an iterator over the bag elements. Elements present in the Bag more than
	 * once will be returned repeatedly.
	 *
	 * @return the iterator
	 */
	@Override
	...
	/**
	 * Returns an array of all of this bag's elements. If the input array has more
	 * elements than are in the bag, trailing elements will be set to null.
	 *
	 * @param <T>
	...
	public <T> T[] toArray(T[] array) {
		...
		while (it.hasNext()) {
			final E current = it.next();
			for (int index = getCount(current); index > 0; index--) {
				// unsafe, will throw ArrayStoreException if types are not compatible, see
				// javadoc
	...
	// -----------------------------------------------------------------------
	/**
	 * Compares this Bag to another. This Bag equals another Bag if it contains the
	 * same number of occurrences of the same elements.
	 *
	 * @param object
	 ...
	 * <code>(e==null ? 0 : e.hashCode()) ^ noOccurances)</code>. This hash code is
	 * compatible with the Set interface.
	 *
