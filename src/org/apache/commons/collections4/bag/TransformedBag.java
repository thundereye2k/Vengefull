...
public class TransformedBag<E> extends TransformedCollection<E> implements Bag<E> {
	 ...
	 * <p>
	 * If there are any elements already in the bag being decorated, they are NOT
	 * transformed. Contrast this with {@link #transformedBag(Bag, Transformer)}.
	 *
	 * @param <E>
	...
	/**
	 * Factory method to create a transforming bag that will transform existing
	 * contents of the specified bag.
	 * <p>
	 * If there are any elements already in the bag being decorated, they will be
	 * transformed by this method. Contrast this with
	 * {@link #transformingBag(Bag, Transformer)}.
	 *
	 * @param <E>
	 *            the type of the elements in the bag
	 * @param bag
