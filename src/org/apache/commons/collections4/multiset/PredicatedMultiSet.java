...
/**
 * Decorates another {@link MultiSet} to validate that additions match a
 * specified predicate.
 * <p>
 * This multiset exists to provide validation for the decorated multiset. It is
 * normally created to decorate an empty multiset. If an object cannot be added
 * to the multiset, an {@link IllegalArgumentException} is thrown.
 * <p>
...
public class PredicatedMultiSet<E> extends PredicatedCollection<E> implements MultiSet<E> {
	 ...
	 * <p>
	 * If there are any elements already in the multiset being decorated, they are
	 * validated.
	 *
	 * @param <E>
	 ...
	 *             if multiset or predicate is null
