 ...
 * map will be used to map multiset elements to a number; the number represents
 * the number of occurrences of that element in the multiset.
 *
 * @since 4.1
...
public abstract class AbstractMapMultiSet<E> extends AbstractMultiSet<E> {
	 ...
	 * multiset. Not intended for interactive use outside of subclasses.
	 *
	...
	// -----------------------------------------------------------------------
	/**
	 * Gets an iterator over the multiset elements. Elements present in the MultiSet
	 * more than once will be returned repeatedly.
	 *
	 * @return the iterator
	 */
	@Override
	...
	/**
	 * Returns an array of all of this multiset's elements. If the input array has
	 * more elements than are in the multiset, trailing elements will be set to
	 * null.
	 *
	 * @param <T>
