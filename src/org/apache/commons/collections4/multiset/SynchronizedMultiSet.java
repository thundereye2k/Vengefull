...
/**
 * Decorates another {@link MultiSet} to synchronize its behaviour for a
 * multi-threaded environment.
 * <p>
 * Methods are synchronized, then forwarded to the decorated multiset. Iterators
 * must be separately synchronized around the loop.
 *
 * @since 4.1
