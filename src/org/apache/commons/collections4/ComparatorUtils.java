...
public class ComparatorUtils {
	 ...
	 * applied in sequence until one returns not equal or the array is exhausted.
	 *
	 * @param <E>
	 *            the object type to compare
	 * @param comparators
	 ...
	 *             if comparators array is null or contains a null
	 * @see ComparatorChain
	 */
	 ...
	 *             if the comparators collection contains the wrong object type
	 * @see ComparatorChain
	 */
	@SuppressWarnings("unchecked")
	 ...
	 *
	 * @param trueFirst
	 *            when <code>true</code>, sort <code>true</code> {@link Boolean}s
	 *            before <code>false</code> {@link Boolean}s.
	 ...
	 * nonnull value, and equal to any other null value. Two nonnull values will be
	 * evaluated with the given comparator.
	 *
	 * @param <E>
	 *            the object type to compare
	 * @param comparator
	 ...
	 * <p>
	 * Objects passed to the returned comparator will first be transformed by the
	 * given transformer before they are compared by the given comparator.
	 *
	 * @param <I>
	 *            the input object type of the transformed comparator
	 * @param <O>
	 *            the object type of the decorated comparator
	 * @param comparator
	 ...
	 * returning the second object if the comparator returns equal.
	 *
	 * @param <E>
	 *            the object type to compare
	 * @param o1
