...
/**
 * Defines a map that allows bidirectional lookup between key and values and
 * retains and provides access to an ordering.
 * <p>
...
public interface OrderedBidiMap<K, V> extends BidiMap<K, V>, OrderedMap<K, V> {
	 ...
	 * both directions of the map to be accessed equally.
	 * <p>
	 * Implementations should seek to avoid creating a new object every time this
	 * method is called. See <code>AbstractMap.values()</code> etc. Calling this
	 * method on the inverse map should return the original.
	 * <p>
	 * Implementations must return an <code>OrderedBidiMap</code> instance, usually
	 * by forwarding to <code>inverseOrderedBidiMap()</code>.
	 *
