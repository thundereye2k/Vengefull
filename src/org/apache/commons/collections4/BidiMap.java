...
public interface BidiMap<K, V> extends IterableMap<K, V> {
	 ...
	 *             if the <code>put</code> method is not supported
	 * @throws ClassCastException
	 *             (optional) if the map limits the type of the value and the
	 *             specified value is inappropriate
	 * @throws IllegalArgumentException
	 *             (optional) if the map limits the values in some way and the value
	 *             was invalid
	 * @throws NullPointerException
	 *             (optional) if the map limits the values to non-null and null was
	 *             specified
	 */
	@Override
	V put(K key, V value);
	 ...
	 * <p>
	 * Implementations should seek to make this method perform equally as well as
	 * <code>get(Object)</code>.
	 *
	 * @param value
	 ...
	 * <p>
	 * Changes to one map will be visible in the other and vice versa. This enables
	 * both directions of the map to be accessed as a <code>Map</code>.
	 * <p>
