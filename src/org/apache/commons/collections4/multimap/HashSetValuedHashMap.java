...
public class HashSetValuedHashMap<K, V> extends AbstractSetValuedMap<K, V> implements Serializable {
	...
	/**
	 * Creates an empty HashSetValuedHashMap with the default initial map capacity
	 * (16) and the default initial set capacity (3).
	 */
	...
	/**
	 * Creates an empty HashSetValuedHashMap with the default initial map capacity
	 * (16) and the specified initial set capacity.
	 *
	 * @param initialSetCapacity
	...
	/**
	 * Creates an empty HashSetValuedHashMap with the specified initial map and list
	 * capacities.
	 *
	 ...
	 *
	 * @param map
	 *            a <code>Map</code> to copy into this map
	 */
