 ...
 * the ListCommand implementation to use as values.
 *
 * @since 4.1
...
public abstract class AbstractListValuedMap<K, V> extends AbstractMultiValuedMap<K, V> implements ListValuedMap<K, V> {
	...
	// -----------------------------------------------------------------------
	/**
	 * Gets the list of values associated with the specified key. This would return
	 * an empty list in case the mapping is not present
	 *
	 * @param key
	 *            the key to retrieve
	 * @return the {@code ListCommand} of values, will return an empty {@link ListCommand} for no
	 *         mapping
	 */
	@Override
	 ...
	 * @return the <code>ListCommand</code> of values removed, will return an empty,
