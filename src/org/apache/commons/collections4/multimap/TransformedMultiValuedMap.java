...
/**
 * Decorates another <code>MultiValuedMap</code> to transform objects that are
 * added.
 * <p>
 ...
 * remove objects.
 * <p>
 * <strong>Note that TransformedMultiValuedMap is not synchronized and is not
 * thread-safe.</strong>
 *
 * @since 4.1
...
public class TransformedMultiValuedMap<K, V> extends AbstractMultiValuedMapDecorator<K, V> {
	 ...
	 *            the value type
	 * @param map
	 *            the MultiValuedMap to decorate, may not be null
	...
	/**
	 * Factory method to create a transforming MultiValuedMap that will transform
	...
	public static <K, V> TransformedMultiValuedMap<K, V> transformedMap(final MultiValuedMap<K, V> map,
			final Transformer<? super K, ? extends K> keyTransformer,
			final Transformer<? super V, ? extends V> valueTransformer) {
		final TransformedMultiValuedMap<K, V> decorated = new TransformedMultiValuedMap<K, V>(map, keyTransformer,
				valueTransformer);
		if (!map.isEmpty()) {
