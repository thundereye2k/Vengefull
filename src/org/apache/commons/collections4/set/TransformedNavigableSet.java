...
/**
 * Decorates another <code>NavigableSet</code> to transform objects that are
 * added.
 * <p>
 * The add methods are affected by this class. Thus objects must be removed or
 * searched for using their transformed form. For example, if the transformation
 * converts Strings to Integers, you must use the Integer form to remove
 * objects.
 *
 * @since 4.1
...
public class TransformedNavigableSet<E> extends TransformedSortedSet<E> implements NavigableSet<E> {
	 ...
	 * <p>
	 * If there are any elements already in the set being decorated, they are NOT
	 * transformed. Contrast this with
	 * {@link #transformedNavigableSet(NavigableSet, Transformer)}.
	 *
	 * @param <E>
	 *            the element type
	 * @param set
	 ...
	 * <p>
	 * If there are any elements already in the set being decorated, they will be
	 * transformed by this method. Contrast this with
	 * {@link #transformingNavigableSet(NavigableSet, Transformer)}.
	 *
	 * @param <E>
	 *            the element type
	 * @param set
