...
/**
 * Decorates another <code>SortedSet</code> to validate that all additions match
 * a specified predicate.
 * <p>
 * This set exists to provide validation for the decorated set. It is normally
 * created to decorate an empty set. If an object cannot be added to the set, an
...
public class PredicatedSortedSet<E> extends PredicatedSet<E> implements SortedSet<E> {
	 ...
	 * <p>
	 * If there are any elements already in the set being decorated, they are
	 * validated.
	 *
	 * @param <E>
	 *            the element type
