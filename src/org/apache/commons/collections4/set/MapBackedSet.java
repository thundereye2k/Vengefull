 ...
 * <p>
 * Most map implementation can be used to create a set by passing in dummy
 * values. Exceptions include <code>BidiMap</code> implementations, as they
...
public final class MapBackedSet<E, V> implements Set<E>, Serializable {
	 ...
	 *            the element type
	 * @param <V>
	 *            the dummy value type in the map
	 * @param map
