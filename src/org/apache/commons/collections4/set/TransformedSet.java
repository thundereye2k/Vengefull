...
public class TransformedSet<E> extends TransformedCollection<E> implements Set<E> {
	 ...
	 * transformed. Contrast this with {@link #transformedSet(Set, Transformer)}.
	 *
	 * @param <E>
	 *            the element type
	 * @param set
	...
	/**
	 * Factory method to create a transforming set that will transform existing
	 ...
	 * {@link #transformingSet(Set, Transformer)}.
	 *
	 * @param <E>
	 *            the element type
	 * @param set
