...
/**
 * A FluentIterable provides a powerful yet simple API for manipulating Iterable
 * instances in a fluent manner.
 * <p>
 * A FluentIterable can be created either from an Iterable or from a set of
 * elements. The following types of methods are provided:
 * <ul>
 ...
 * <li>conversion methods which copy the FluentIterable's contents into a new
 * collection or array (e.g. toList());
...
public class FluentIterable<E> implements Iterable<E> {
	 ...
	 *            the element type
	 * @param elements
	 *            the elements to be contained in the FluentIterable
	...
	/**
	 * Construct a new FluentIterable from the provided iterable. If the iterable is
	 * already an instance of FluentIterable, the instance will be returned instead.
	 * <p>
	 ...
	 *            the element type
	 * @param iterable
	 *            the iterable to wrap into a FluentIterable, may not be null
	...
	/**
	 * Returns a new FluentIterable whose iterator will first traverse the elements
	 * of the current iterable, followed by the provided elements.
	 *
	 * @param elements
	 *            the elements to append to the iterable
	...
	/**
	 * Returns a new FluentIterable whose iterator will first traverse the elements
	 * of the current iterable, followed by the elements of the provided iterable.
	 *
	 * @param other
	 *            the other iterable to combine, may not be null
	...
	/**
	 * Returns a new FluentIterable whose iterator will traverse the elements of the
	 * current and provided iterable in natural order.
	 * <p>
	 ...
	 * </ul>
	 * <p>
	 * The returned iterable will traverse the elements in the following order: [1,
	 * 2, 3, 4, 5, 6, 7, 8]
	 *
	 * @param other
	 *            the other iterable to collate, may not be null
	 * @return a new iterable, collating this iterable with the other in natural
	 *         order
	 * @throws NullPointerException
	 *             if other is null
	 * @see {@link org.apache.commons.collections4.iterators.CollatingIterator
	 *      CollatingIterator}
	 */
	...
	/**
	 * Returns a new FluentIterable whose iterator will traverse the elements of the
	 * current and provided iterable according to the ordering defined by an
	 * comparator.
	 * <p>
	 ...
	 * </ul>
	 * <p>
	 * The returned iterable will traverse the elements in the following order: [8,
	 * 7, 6, 5, 4, 3, 2, 1]
	 *
	 * @param comparator
	 *            the comparator to define an ordering, may be null, in which case
	...
	/**
	 * This method fully traverses an iterator of this iterable and returns a new
	 * iterable with the same contents, but without any reference to the originating
	 * iterables and/or iterators.
	 * <p>
	...
	/**
	 * Returns a new FluentIterable whose iterator will only return elements from
	 * this iterable matching the provided predicate.
	 *
	 * @param predicate
	...
	/**
	 * Returns a new FluentIterable whose iterator will return at most the provided
	 * maximum number of elements from this iterable.
	 *
	 * @param maxSize
	...
	/**
	 * Returns a new FluentIterable whose iterator will loop infinitely over the
	...
	/**
	 * Returns a new FluentIterable whose iterator will traverse the elements from
	 * this iterable in reverse order.
	 *
	...
	/**
	 * Returns a new FluentIterable whose iterator will skip the first N elements
	 * from this iterable.
	 *
	 * @param elementsToSkip
	 *            the number of elements to skip
	 * @return a new iterable, providing a view of this iterable by skipping the
	 *         first N elements
	 * @throws IllegalArgumentException
	...
	/**
	 * Returns a new FluentIterable whose iterator will return all elements of this
	 * iterable transformed by the provided transformer.
	 *
	 * @param <O>
	 *            the output element type
	 * @param transformer
	 *            the transformer applied to each element
	...
	/**
	 * Returns a new FluentIterable whose iterator will return a unique view of this
	 * iterable.
	 *
	...
	/**
	 * Returns a new FluentIterable whose iterator will return an unmodifiable view
	 * of this iterable.
	 *
	...
	/**
	 * Returns a new FluentIterable whose iterator will traverse the elements of
	 * this iterable and the other iterable in alternating order.
	 *
	 * @param other
	 *            the other iterable to interleave, may not be null
	...
	/**
	 * Returns a new FluentIterable whose iterator will traverse the elements of
	 * this iterable and the other iterables in alternating order.
	 *
	 * @param others
	 *            the iterables to interleave, may not be null
	 * @return a new iterable, interleaving this iterable with others
	 * @throws NullPointerException
	...
	/**
	 * Returns an Enumeration that will enumerate all elements contained in this
	 * iterable.
	 *
	...
	/**
	 * Checks if all elements contained in this iterable are matching the provided
	 * predicate.
	 * <p>
	 ...
	 * @param predicate
	 *            the predicate to use, may not be null
	 * @return true if at least one element contained in this iterable matches the
	...
	/**
	 * Returns the element at the provided position in this iterable. In order to
	 * return the element, an iterator needs to be traversed up to the requested
	 * position.
	 *
	 * @param position
	 ...
	 *             if the provided position is outside the valid range of this
	 *             iterable: [0, size)
	 */
	...
	/**
	 * Returns the number of elements that are contained in this iterable. In order
	 * to determine the size, an iterator needs to be traversed.
	 *
	...
	/**
	 * Traverses an iterator of this iterable and adds all elements to the provided
	 * collection.
	 *
	 * @param collection
	...
	/**
	 * Returns an array containing all elements of this iterable by traversing its
	 * iterator.
	 *
	 * @param arrayClass
	...
	/**
	 * Returns a mutable list containing all elements of this iterable by traversing
	 * its iterator.
	 * <p>
