 ...
 * <p>
 * <b>Note</b>: this util class has been designed for fail-fast argument
 * checking.
 * <ul>
 * <li>all decorator methods are <b>NOT</b> null-safe wrt the provided Iterable
 * argument, i.e. they will throw a {@link NullPointerException} if a null
 * Iterable is passed as argument.
 * <li>all other utility methods are null-safe wrt the provided Iterable
 * argument, i.e. they will treat a null Iterable the same way as an empty one.
 * Other arguments which are null, e.g. a {@link Predicate}, will result in a
...
public class IterableUtils {
	 ...
	 * {@code a}, followed by the elements in {@code b}. The source iterators are
	 ...
	 * <p>
	 * The returned iterable has an iterator that traverses the elements in
	 * {@code a}, followed by the elements in {@code b} and {@code c}. The source
	 ...
	 * <p>
	 * The returned iterable has an iterator that traverses the elements in
	 * {@code a}, followed by the elements in {@code b}, {@code c} and {@code d}.
	 ...
	 *            the third iterable, may not be null
	 * @param d
	 *            the fourth iterable, may not be null
	 * @return a new iterable, combining the provided iterables
	 * @throws NullPointerException
	 *             if either of the provided iterables is null
	 */
	@SuppressWarnings("unchecked")
	public static <E> Iterable<E> chainedIterable(final Iterable<? extends E> a, final Iterable<? extends E> b,
			final Iterable<? extends E> c, final Iterable<? extends E> d) {
	 ...
	 * <p>
	 * The returned iterable has an iterator that traverses the elements in the
	 * order of the arguments, i.e. iterables[0], iterables[1], .... The source
	 * iterators are not polled until necessary.
	 * <p>
	 * The returned iterable's iterator supports {@code remove()} when the
	 * corresponding input iterator supports it.
	...
	/**
	 * Combines the two provided iterables into an ordered iterable using natural
	 * ordering.
	 * <p>
	 * The returned iterable's iterator supports {@code remove()} when the
	 * corresponding input iterator supports it.
	 ...
	 *            the element type
	 * @param comparator
	 *            the comparator defining an ordering over the elements, may be
	 *            null, in which case natural ordering will be used
	 * @param a
	 *            the first iterable, may not be null
	 * @param b
	 *            the second iterable, may not be null
	...
	/**
	 * Returns a view of the given iterable that only contains elements matching the
	 * provided predicate.
	 * <p>
	 * The returned iterable's iterator supports {@code remove()} when the
	 * corresponding input iterator supports it.
	 ...
	 *            the element type
	 * @param iterable
	 *            the iterable to filter, may not be null
	 * @param predicate
	 *            the predicate used to filter elements, may not be null
	 * @return a filtered view on the specified iterable
	 * @throws NullPointerException
	 *             if either iterable or predicate is null
	 */
	 ...
	 *            the element type
	 * @param iterable
	 *            the iterable to limit, may not be null
	 * @param maxSize
	 *            the maximum number of elements, must not be negative
	...
	/**
	 * Returns a view of the given iterable which will cycle infinitely over its
	 * elements.
	 * <p>
	 * The returned iterable's iterator supports {@code remove()} if
	 * {@code iterable.iterator()} does. After {@code remove()} is called,
	 * subsequent cycles omit the removed element, which is no longer in
	 * {@code iterable}. The iterator's {@code hasNext()} method returns
	 * {@code true} until {@code iterable} is empty.
	 *
	 * @param <E>
	 *            the element type
	 * @param iterable
	 *            the iterable to loop, may not be null
	 ...
	 * <p>
	 * In case the provided iterable is a {@link ListCommand} instance, a
	 * {@link ReverseListIterator} will be used to reverse the traversal order,
	 * otherwise an intermediate {@link ListCommand} needs to be created.
	 * <p>
	 * The returned iterable's iterator supports {@code remove()} if the provided
	 * iterable is a {@link ListCommand} instance.
	 *
	 * @param <E>
	 *            the element type
	 * @param iterable
	...
	public static <E> Iterable<E> reversedIterable(final Iterable<E> iterable) {
		...
		return new FluentIterable<E>() {
			@Override
			public Iterator<E> iterator() {
				final List<E> list = (iterable instanceof List<?>) ? (List<E>) iterable
	 ...
	 *            the number of elements to skip from the start, must not be
	 *            negative
	 * @return a view of the specified iterable, skipping the first N elements
	 * @throws IllegalArgumentException
	 *             if elementsToSkip is negative
	 * @throws NullPointerException
	 *             if iterable is null
	 */
	 ...
	 * <p>
	 * The returned iterable's iterator supports {@code remove()} when the
	 * corresponding input iterator supports it. Calling {@code remove()} will only
	 * remove a single element from the underlying iterator.
	 *
	 * @param <E>
	 *            the element type
	 * @param iterable
	 ...
	 * <p>
	 * The returned iterable has an iterator that traverses the elements in
	 * {@code a} and {@code b} in alternating order. The source iterators are not
	 ...
	 *            the first iterable, may not be null
	 * @param others
	 *            the array of iterables to interleave, may not be null
	 * @return a new iterable, interleaving the provided iterables
	 * @throws NullPointerException
	 *             if either of the provided iterables is null
	 */
	...
	/**
	 * Returns an immutable empty iterable if the argument is null, or the argument
	 * itself otherwise.
	 *
	 * @param <E>
	 *            the element type
	 ...
	 * @return the last element in the iterable, or null if iterable is null or
	 *         empty
	 */
	 ...
	 * @return the first element of the iterable which matches the predicate or null
	...
	/**
	 * Returns the index of the first element in the specified iterable that matches
	 * the given predicate.
	 * <p>
	 ...
	 * @param predicate
	 *            the predicate to use, may not be null
	 * @return the index of the first element which matches the predicate or -1 if
	 *         none matches
	 * @throws NullPointerException
	 *             if predicate is null
	 */
	 ...
	 * @param predicate
	 *            the predicate to use, may not be null
	 * @return true if every element of the collection matches the predicate or if
	 ...
	 * @param predicate
	 *            the predicate to use, may not be null
	 * @return true if any element of the collection matches the predicate, false
	 *         otherwise
	 * @throws NullPointerException
	 *             if predicate is null
	 */
	...
	/**
	 * Checks if the object is contained in the given iterable. Object equality is
	 * tested with an {@code equator} unlike {@link #contains(Iterable, Object)}
	 * which uses {@link Object#equals(Object)}.
	 * <p>
	 * A <code>null</code> or empty iterable returns false. A <code>null</code>
	 ...
	 *
	 * @param <E>
	 *            the element type that the {@link Iterable} may contain
	 * @param <T>
	 *            the element type of the object to find
	 * @param iterable
	 *            the {@link Iterable} to search
	 * @param obj
	 ...
	 * {@link Iterator}, throwing <code>IndexOutOfBoundsException</code> if there is
	 * no such element.
	 * <p>
	 * If the {@link Iterable} is a {@link ListCommand}, then it will use
	 * {@link ListCommand#get(int)}.
	 *
	 * @param <T>
	...
	/**
	 * Partitions all elements from iterable into separate output collections, based
	 * on the evaluation of the given predicate.
	 * <p>
	 * For each predicate, the result will contain a list holding all elements of
	 * the input iterable matching the predicate. The last list will hold all
	 ...
	 * empty iterable.
	 * <p>
	 * Example: for an input list [1, 2, 3, 4, 5] calling partition with a predicate
	 * [x &lt; 3] will result in the following output: [[1, 2], [3, 4, 5]].
	 *
	 * @param <O>
	 *            the type of object the {@link Iterable} contains
	 * @param iterable
	 *            the iterable to partition, may be null
	 * @param predicate
	 *            the predicate to use, may not be null
	...
	/**
	 * Partitions all elements from iterable into separate output collections, based
	 * on the evaluation of the given predicates.
	 * <p>
	 * For each predicate, the result will contain a list holding all elements of
	 * the input iterable matching the predicate. The last list will hold all
	 * elements which didn't match any predicate:
	 ...
	 * </pre>
	 * <p>
	 * <b>Note</b>: elements are only added to the output collection of the first
	 * matching predicate, determined by the order of arguments.
	 * <p>
	 * If the input iterable is <code>null</code>, the same is returned as for an
	 * empty iterable.
	 * <p>
	 * Example: for an input list [1, 2, 3, 4, 5] calling partition with predicates
	 * [x &lt; 3] and [x &lt; 5] will result in the following output: [[1, 2], [3,
	 * 4], [5]].
	 *
	 * @param <O>
	 *            the type of object the {@link Iterable} contains
	 ...
	 * @param predicates
	 *            the predicates to use, may not be null
	 * @return a list containing the output collections
	 * @throws NullPointerException
	 ...
	 * on the evaluation of the given predicates.
	 * <p>
	 * For each predicate, the returned list will contain a collection holding all
	 * elements of the input iterable matching the predicate. The last collection
	 ...
	 * <p>
	 * If the input iterable is <code>null</code>, the same is returned as for an
	 * empty iterable. If no predicates have been provided, all elements of the
	 * input collection will be added to the rejected collection.
	 * <p>
	 * Example: for an input list [1, 2, 3, 4, 5] calling partition with predicates
	 * [x &lt; 3] and [x &lt; 5] will result in the following output: [[1, 2], [3,
	 * 4], [5]].
	...
	/**
	 * Returns an empty iterator if the argument is <code>null</code>, or
	 * {@code iterable.iterator()} otherwise.
	 *
	 * @param <E>
	 *            the element type
	 * @param iterable
