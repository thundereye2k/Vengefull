...
public class MultiSetUtils {
	 ...
	 *            the element type
	 * @param multiset
	 *            the multiset to synchronize, must not be null
	 ...
	 *            the element type
	 * @param multiset
	 *            the multiset whose unmodifiable view is to be returned, must not
	 *            be null
	 ...
	 * multiset. Trying to add an invalid object results in an
	 ...
	 * @param predicate
	 *            the predicate for the multiset, must not be null
