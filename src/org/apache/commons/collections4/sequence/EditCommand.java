 ...
 * commands that progressively transform the first sequence into the second one.
 * <p>
...
public abstract class EditCommand<T> {
	 ...
	 *
	 * @param object
	 *            reference to the object associated with this command, this refers
	 *            to an element of one of the sequences being compared
	 */
	 ...
	 * Accept a visitor.
	 * <p>
	 * This method is invoked for each commands belonging to an {@link EditScript
	 * EditScript}, in order to implement the visitor design pattern
	 *
	 * @param visitor
