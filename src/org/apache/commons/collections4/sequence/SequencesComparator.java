 ...
 * <a href="http://www.cis.upenn.edu/~bcpierce/courses/dd/papers/diff.ps"> An
 * O(ND) Difference Algorithm and Its Variations</a>. This algorithm produces
 * the shortest possible {@link EditScript edit script} containing all the
 * {@link EditCommand commands} needed to transform the first sequence into the
 * second one.
 *
 * @see EditScript
 * @see EditCommand
...
public class SequencesComparator<T> {
	 ...
	 * important if subclassing is used for some elements in the first sequence and
	 * the <code>equals</code> method is specialized.
	 *
	 * @param sequence1
	 ...
	 * <p>
	 * It is <em>guaranteed</em> that the comparisons will always be done as
	 * <code>Equator.equate(o1, o2)</code> where <code>o1</code> belongs to the
	 * first sequence and <code>o2</code> belongs to the second sequence.
	 *
	 * @param sequence1
	 *            first sequence to be compared
	 * @param sequence2
	 ...
	 *
	 * @param start
	 *            the value of the start of the snake
	 * @param diag
	 *            the value of the diagonal of the snake
	 * @param end1
	 *            the value of the end of the first sequence to be compared
	 * @param end2
	 *            the value of the end of the second sequence to be compared
	 ...
	 * <p>
	 * The snake is found using the MYERS Algorithm (this algorithms has also been
	 * implemented in the GNU diff program). This algorithm is explained in Eugene
	 * Myers article:
	 * <a href="http://www.cs.arizona.edu/people/gene/PAPERS/diff.ps"> An O(ND)
	 * Difference Algorithm and Its Variations</a>.
	 *
	 * @param start1
	 *            the begin of the first sequence to be compared
	 * @param end1
	 *            the end of the first sequence to be compared
	 * @param start2
	 *            the begin of the second sequence to be compared
	 * @param end2
	 *            the end of the second sequence to be compared
	 ...
	 * construction in a {@link SequencesComparator SequencesComparator}.
	 */
