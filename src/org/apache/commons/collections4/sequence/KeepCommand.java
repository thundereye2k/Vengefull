...
public class KeepCommand<T> extends EditCommand<T> {
	 ...
	 *
	 * @param object
	 *            the object belonging to both sequences (the object is a reference
	 *            to the instance in the first sequence which is known to be equal
	 *            to an instance in the second sequence)
	 */
	...
	/**
	 * Accept a visitor. When a <code>KeepCommand</code> accepts a visitor, it calls
