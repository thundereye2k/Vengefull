 ...
 * {@link EditScript EditScript} objects.
 * <p>
 * Users should implement this interface in order to walk through the
 * {@link EditScript EditScript} object created by the comparison of two
 * sequences. This is a direct application of the visitor design pattern. The
 * {@link EditScript#visit EditScript.visit} method takes an object implementing
 * this interface as an argument, it will perform the loop over all commands in
 * the script and the proper methods of the user class will be called as the
 * commands are encountered.
 * <p>
 * The implementation of the user visitor class will depend on the need. Here
 * are two examples.
 * <p>
 ...
 * </pre>
 * <p>
 * The second example is a visitor that shows the commands and the way they
