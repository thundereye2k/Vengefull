...
public class EditScript<T> {
	...
	/**
	 * Visit the script. The script implements the <em>visitor</em> design pattern,
	 * this method is the entry point to which the user supplies its own visitor,
	 * the script will be responsible to drive it through the commands in order and
	 * call the appropriate method as each command is encountered.
	 *
	 * @param visitor
	 ...
	 * longest common subsequence is the number of {@link KeepCommand keep commands}
	 * in the script.
	 *
