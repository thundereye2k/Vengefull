...
public class TShortArrayList implements TShortList, Externalizable {
	...
	/**
	 * Creates a new <code>TShortArrayList</code> instance with the default
	 * capacity.
	 */
	...
	/**
	 * Creates a new <code>TShortArrayList</code> instance with the specified
	 * capacity.
	 *
	 * @param capacity
	...
	/**
	 * Creates a new <code>TShortArrayList</code> instance that contains a copy of
	...
	/**
	 * Creates a new <code>TShortArrayList</code> instance whose capacity is the
