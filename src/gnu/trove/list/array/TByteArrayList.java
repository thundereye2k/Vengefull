...
public class TByteArrayList implements TByteList, Externalizable {
	...
	/**
	 * Creates a new <code>TByteArrayList</code> instance with the default capacity.
	 */
	 ...
	 *            an <code>byte</code> value that represents null.
	 */
	...
	/**
	 * Creates a new <code>TByteArrayList</code> instance that contains a copy of
	...
	/**
	 * Creates a new <code>TByteArrayList</code> instance whose capacity is the
