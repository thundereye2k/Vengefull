...
public class TFloatArrayList implements TFloatList, Externalizable {
	...
	/**
	 * Creates a new <code>TFloatArrayList</code> instance with the default
	 * capacity.
	 */
	...
	/**
	 * Creates a new <code>TFloatArrayList</code> instance with the specified
	 * capacity.
	 *
	 * @param capacity
	 ...
	 *            an <code>float</code> value that represents null.
	 */
	...
	/**
	 * Creates a new <code>TFloatArrayList</code> instance that contains a copy of
	...
	/**
	 * Creates a new <code>TFloatArrayList</code> instance whose capacity is the
	...
	/**
	 * Returns a primitive ListCommand implementation that wraps around the given primitive
	 * array.
	 * <p/>
	 * NOTE: mutating operation are allowed as long as the ListCommand does not grow. In
