...
public class TDoubleArrayList implements TDoubleList, Externalizable {
	...
	/**
	 * Creates a new <code>TDoubleArrayList</code> instance with the default
	 * capacity.
	 */
	...
	/**
	 * Creates a new <code>TDoubleArrayList</code> instance with the specified
	 * capacity.
	 *
	 * @param capacity
	...
	/**
	 * Creates a new <code>TDoubleArrayList</code> instance that contains a copy of
	...
	/**
	 * Creates a new <code>TDoubleArrayList</code> instance whose capacity is the
