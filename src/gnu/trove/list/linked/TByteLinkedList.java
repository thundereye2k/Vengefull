...
public class TByteLinkedList implements TByteList, Externalizable {
	 ...
	 * <p/>
	 * A simple bisection criteria is used to keep the worst case complexity equal
	 * to O(n/2) where n = size(). Simply start from head of list or tail depending
	 * on offset and list size.
	 *
	 * @param offset
	 *            of the link
	...
	/**
	 * Returns the link at absolute offset starting from given the initial link 'l'
	 * at index 'idx'
	 *
	 * @param l
	 * @param idx
