...
public interface TDoubleList extends TDoubleCollection {
	 ...
	 * and to the right of <tt>offset</tt> are shifted to the right.
	 *
	 * @param offset
	 ...
	 * <tt>offset</tt>. All values including and to the right of <tt>offset</tt> are
	...
	/**
	 * Replace the values in the list starting at <tt>offset</tt> with the contents
	 * of the <tt>values</tt> array.
	 *
	 * @param offset
	 ...
	 * <tt>length</tt> values from the <tt>values</tt> array, starting at valOffset.
	 *
	 * @param offset
	 *            the first offset to replace
	 * @param values
	 ...
	 *
	 * @param offset
	 *            an <code>int</code> value that represents the offset to the
	 ...
	 *
	 * @param function
	 *            a <code>TDoubleFunction</code> value
	 */
	 ...
	 *
	 * <p>
	 * NOTE: Trove does not allocate a new array if the array passed in is not large
	 * enough to hold all of the data elements. It will instead fill the array
	 * passed in.
	 *
	 * @param dest
	...
	/**
	 * Applies the procedure to each value in the list in ascending (front to back)
	 * order.
	 *
	 * @param procedure
	 *            a <code>TDoubleProcedure</code> value
	...
	/**
	 * Applies the procedure to each value in the list in descending (back to front)
	 * order.
	 *
	 * @param procedure
	 *            a <code>TDoubleProcedure</code> value
	...
	/**
	 * Performs a binary search for <tt>value</tt> in the entire list. Note that you
	 * <b>must</b> @{link #sort sort} the list before doing a search.
	 *
	 * @param value
	...
	/**
	 * Performs a binary search for <tt>value</tt> in the specified range. Note that
	 * you <b>must</b> @{link #sort sort} the list or the range before doing a
	 * search.
	 *
	 * @param value
	 *            the value to search for
	...
	/**
	 * Searches the list front to back for the index of <tt>value</tt>, starting at
	 * <tt>offset</tt>.
	 *
	 * @param offset
