 ...
 * Implementers can use this interface to make the trove hashing algorithms use
...
public interface HashingStrategy<T> extends Serializable {
	...
	/**
	 * Computes a hash code for the specified object. Implementers can use the
	...
	/**
	 * Compares o1 and o2 for equality. Strategy implementers may use the objects'
