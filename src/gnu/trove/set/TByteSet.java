...
public interface TByteSet extends TByteCollection {
	...
	/**
	 * Creates an iterator over the values of the set. The iterator supports element
	 * deletion.
	 *
	 ...
	 * caller knows that this set does not contain any elements representing null.)
	 *
	 * <p>
	...
	/**
	 * Tests the set to determine if all of the elements in <tt>collection</tt> are
	 * present.
	 *
	 * @param collection
	...
	/**
	 * Tests the set to determine if all of the elements in <tt>TByteCollection</tt>
	 * are present.
	 *
	 * @param collection
	 *            a <code>TByteCollection</code> value
	 * @return true if all elements were present in the set.
	 */
	@Override
	 ...
	 *
	 * @param array
	 *            as <code>array</code> of byte primitives.
	 * @return true if all elements were present in the set.
	 */
	@Override
	 ...
	 *
	 * @param array
	 *            an <code>array</code> of byte primitives.
	 * @return true if the set was modified by the retain all operation
	 */
	@Override
	 ...
	 * to be the sum of the hash codes of the elements in the set. This ensures that
