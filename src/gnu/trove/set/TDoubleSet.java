...
public interface TDoubleSet extends TDoubleCollection {
	 ...
	 *
	 * @param collection
	 *            a <code>TDoubleCollection</code> value
	 * @return true if all elements were present in the set.
	 */
	@Override
	 ...
	 *
	 * @param array
	 *            as <code>array</code> of double primitives.
	 * @return true if all elements were present in the set.
	 */
	@Override
	 ...
	 *
	 * @param array
	 *            a <code>array</code> of double primitives.
	 * @return true if the set was modified by the add all operation.
	 */
	@Override
	 ...
	 *
	 * @param array
	 *            an <code>array</code> of double primitives.
	 * @return true if the set was modified by the retain all operation
	 */
	@Override
