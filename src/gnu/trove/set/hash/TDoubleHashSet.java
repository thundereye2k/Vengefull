...
public class TDoubleHashSet extends TDoubleHash implements TDoubleSet, Externalizable {
	...
	/**
	 * Creates a new <code>TDoubleHashSet</code> instance with the default capacity
	 * and load factor.
	 */
	...
	/**
	 * Creates a new <code>TDoubleHashSet</code> instance with a prime capacity
	 ...
	 *            a <code>double</code> value that represents null.
	 */
	...
	/**
	 * Creates a new <code>TDoubleHashSet</code> instance that is a copy of the
	 * existing Collection.
	 *
	 * @param collection
	 ...
	 *
	 * @param collection
	 *            a <tt>TDoubleSet</tt> that will be duplicated.
	 */
	...
	/**
	 * Creates a new <code>TDoubleHashSet</code> instance containing the elements of
	 * <tt>array</tt>.
	 *
	 * @param array
	 *            an array of <code>double</code> primitives
	 */
