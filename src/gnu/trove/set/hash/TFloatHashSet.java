...
public class TFloatHashSet extends TFloatHash implements TFloatSet, Externalizable {
	...
	/**
	 * Creates a new <code>TFloatHashSet</code> instance with the default capacity
	 * and load factor.
	 */
	...
	/**
	 * Creates a new <code>TFloatHashSet</code> instance with a prime capacity equal
	 * to or greater than <tt>initialCapacity</tt> and with the default load factor.
	 *
	 ...
	 *            a <code>float</code> value that represents null.
	 */
	...
	/**
	 * Creates a new <code>TFloatHashSet</code> instance that is a copy of the
	 * existing Collection.
	 *
	 * @param collection
	 ...
	 *
	 * @param collection
	 *            a <tt>TFloatSet</tt> that will be duplicated.
	 */
	...
	/**
	 * Creates a new <code>TFloatHashSet</code> instance containing the elements of
	 * <tt>array</tt>.
	 *
	 * @param array
	 *            an array of <code>float</code> primitives
	 */
