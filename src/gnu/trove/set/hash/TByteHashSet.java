...
public class TByteHashSet extends TByteHash implements TByteSet, Externalizable {
	...
	/**
	 * Creates a new <code>TByteHashSet</code> instance with the default capacity
	 * and load factor.
	 */
	public TByteHashSet() {
		super();
	...
	/**
	 * Creates a new <code>TByteHashSet</code> instance with a prime capacity equal
	 ...
	 *            a <code>byte</code> value that represents null.
	 */
	...
	/**
	 * Creates a new <code>TByteHashSet</code> instance that is a copy of the
	 * existing Collection.
	 *
	 * @param collection
	 ...
	 *
	 * @param collection
	 *            a <tt>TByteSet</tt> that will be duplicated.
	 */
	...
	/**
	 * Creates a new <code>TByteHashSet</code> instance containing the elements of
	 * <tt>array</tt>.
	 *
	 * @param array
	 *            an array of <code>byte</code> primitives
	 */
