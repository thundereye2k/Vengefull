...
/**
 * Created by IntelliJ IDEA. User: Johan Date: 15/03/11 Time: 18:15 To change
...
public class TLinkedHashSet<E> extends THashSet<E> {
	...
	/**
	 * Creates a new <code>THashSet</code> instance with the default capacity and
	 * load factor.
	 */
	...
	/**
	 * Creates a new <code>THashSet</code> instance with a prime capacity equal to
	...
	/**
	 * Creates a new <code>THashSet</code> instance with a prime capacity equal to
	 * or greater than <tt>initialCapacity</tt> and with the specified load factor.
	 *
	 * @param initialCapacity
	 *            an <code>int</code> value
	 * @param loadFactor
	...
	class ForEachProcedure implements TIntProcedure {
		...
		/**
		 * Executes this procedure. A false return value indicates that the application
		 * executing this procedure should not invoke this procedure again.
		 *
		 * @param value
