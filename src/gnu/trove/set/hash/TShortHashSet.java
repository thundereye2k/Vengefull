...
public class TShortHashSet extends TShortHash implements TShortSet, Externalizable {
	...
	/**
	 * Creates a new <code>TShortHashSet</code> instance with the default capacity
	 * and load factor.
	 */
	...
	/**
	 * Creates a new <code>TShortHashSet</code> instance with a prime capacity equal
	 ...
	 *            a <code>short</code> value that represents null.
	 */
	...
	/**
	 * Creates a new <code>TShortHashSet</code> instance that is a copy of the
	 * existing Collection.
	 *
	 * @param collection
	 ...
	 *
	 * @param collection
	 *            a <tt>TShortSet</tt> that will be duplicated.
	 */
	...
	/**
	 * Creates a new <code>TShortHashSet</code> instance containing the elements of
	 * <tt>array</tt>.
	 *
	 * @param array
	 *            an array of <code>short</code> primitives
	 */
