...
public class TCharHashSet extends TCharHash implements TCharSet, Externalizable {
	...
	/**
	 * Creates a new <code>TCharHashSet</code> instance with the default capacity
	 * and load factor.
	 */
	public TCharHashSet() {
		super();
	...
	/**
	 * Creates a new <code>TCharHashSet</code> instance with a prime capacity equal
	 ...
	 *            a <code>char</code> value that represents null.
	 */
	...
	/**
	 * Creates a new <code>TCharHashSet</code> instance that is a copy of the
	 * existing Collection.
	 *
	 * @param collection
	...
	/**
	 * Creates a new <code>TCharHashSet</code> instance containing the elements of
	 * <tt>array</tt>.
	 *
	 * @param array
	 *            an array of <code>char</code> primitives
	 */
