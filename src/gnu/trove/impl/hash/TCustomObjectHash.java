...
abstract public class TCustomObjectHash<T> extends TObjectHash<T> {
	...
	/**
	 * Creates a new <code>TManualObjectHash</code> instance with the default
	...
	/**
	 * Creates a new <code>TManualObjectHash</code> instance whose capacity is the
	...
	/**
	 * Creates a new <code>TManualObjectHash</code> instance with a prime value at
