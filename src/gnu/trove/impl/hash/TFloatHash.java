...
abstract public class TFloatHash extends TPrimitiveHash {
	...
	/**
	 * Creates a new <code>TFloatHash</code> instance with the default capacity and
	 * load factor.
	 */
	public TFloatHash() {
		super();
	...
	/**
	 * Creates a new <code>TFloatHash</code> instance whose capacity is the next
	...
	/**
	 * Creates a new <code>TFloatHash</code> instance with a prime value at or near
