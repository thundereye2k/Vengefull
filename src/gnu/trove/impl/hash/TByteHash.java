...
abstract public class TByteHash extends TPrimitiveHash {
	...
	/**
	 * Creates a new <code>TByteHash</code> instance with the default capacity and
	 * load factor.
	 */
	public TByteHash() {
		super();
	...
	/**
	 * Creates a new <code>TByteHash</code> instance whose capacity is the next
	...
	/**
	 * Creates a new <code>TByteHash</code> instance with a prime value at or near
