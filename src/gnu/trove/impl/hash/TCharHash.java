...
abstract public class TCharHash extends TPrimitiveHash {
	...
	/**
	 * Creates a new <code>TCharHash</code> instance with the default capacity and
	 * load factor.
	 */
	public TCharHash() {
		super();
	...
	/**
	 * Creates a new <code>TCharHash</code> instance whose capacity is the next
	...
	/**
	 * Creates a new <code>TCharHash</code> instance with a prime value at or near
