...
abstract public class TDoubleHash extends TPrimitiveHash {
	...
	/**
	 * Creates a new <code>TDoubleHash</code> instance with the default capacity and
	 * load factor.
	 */
	public TDoubleHash() {
		super();
	...
	/**
	 * Creates a new <code>TDoubleHash</code> instance whose capacity is the next
	...
	/**
	 * Creates a new <code>TDoubleHash</code> instance with a prime value at or near
