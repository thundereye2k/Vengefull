...
abstract public class TShortHash extends TPrimitiveHash {
	...
	/**
	 * Creates a new <code>TShortHash</code> instance with the default capacity and
	 * load factor.
	 */
	public TShortHash() {
		super();
	...
	/**
	 * Creates a new <code>TShortHash</code> instance whose capacity is the next
	...
	/**
	 * Creates a new <code>TShortHash</code> instance with a prime value at or near
