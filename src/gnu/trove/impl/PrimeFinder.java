...
public final class PrimeFinder {
	 ...
	 *
	 * The next element is P3, for which the same holds with respect to P2, and so
	 * on.
	 *
	 ...
	 * of 2.0;
	 *
	 * If your hashtable has such a growthfactor then, after initially "rounding to
	 * a prime" upon hashtable construction, it will later expand to prime
