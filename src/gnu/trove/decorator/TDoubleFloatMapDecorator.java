...
/**
 * Wrapper class to make a TDoubleFloatMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TDoubleFloatMap and translates
...
public class TDoubleFloatMapDecorator extends AbstractMap<Double, Float>
	 ...
	 *
	 * @param map
	 *            the <tt>TDoubleFloatMap</tt> to wrap.
	 */
	 ...
	 * @param value
	 *            an <code>Object</code> value
	 * @return the previous value associated with <tt>key</tt>, or Float(0) if none
	 *         was found.
	 */
	@Override
