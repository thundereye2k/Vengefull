...
/**
 * Wrapper class to make a TByteLongMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TByteLongMap and translates
...
public class TByteLongMapDecorator extends AbstractMap<Byte, Long>
	 ...
	 *
	 * @param map
	 *            the <tt>TByteLongMap</tt> to wrap.
	 */
