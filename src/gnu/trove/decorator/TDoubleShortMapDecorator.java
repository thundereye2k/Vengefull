...
/**
 * Wrapper class to make a TDoubleShortMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TDoubleShortMap and translates
...
public class TDoubleShortMapDecorator extends AbstractMap<Double, Short>
	 ...
	 *
	 * @param map
	 *            the <tt>TDoubleShortMap</tt> to wrap.
	 */
	 ...
	 * @param value
	 *            an <code>Object</code> value
	 * @return the previous value associated with <tt>key</tt>, or Short(0) if none
	 *         was found.
	 */
	@Override
