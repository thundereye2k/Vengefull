...
/**
 * Wrapper class to make a TDoubleIntMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TDoubleIntMap and translates
...
public class TDoubleIntMapDecorator extends AbstractMap<Double, Integer>
	 ...
	 *
	 * @param map
	 *            the <tt>TDoubleIntMap</tt> to wrap.
	 */
