...
/**
 * Wrapper class to make a TByteDoubleMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TByteDoubleMap and translates
...
public class TByteDoubleMapDecorator extends AbstractMap<Byte, Double>
	 ...
	 *
	 * @param map
	 *            the <tt>TByteDoubleMap</tt> to wrap.
	 */
