...
/**
 * Wrapper class to make a TFloatShortMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TFloatShortMap and translates
...
public class TFloatShortMapDecorator extends AbstractMap<Float, Short>
	 ...
	 *
	 * @param map
	 *            the <tt>TFloatShortMap</tt> to wrap.
	 */
