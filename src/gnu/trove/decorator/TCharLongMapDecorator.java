...
/**
 * Wrapper class to make a TCharLongMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TCharLongMap and translates
...
public class TCharLongMapDecorator extends AbstractMap<Character, Long>
	 ...
	 *
	 * @param map
	 *            the <tt>TCharLongMap</tt> to wrap.
	 */
