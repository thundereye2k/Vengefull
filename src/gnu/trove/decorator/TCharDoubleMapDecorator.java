...
/**
 * Wrapper class to make a TCharDoubleMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TCharDoubleMap and translates
...
public class TCharDoubleMapDecorator extends AbstractMap<Character, Double>
	 ...
	 *
	 * @param map
	 *            the <tt>TCharDoubleMap</tt> to wrap.
	 */
