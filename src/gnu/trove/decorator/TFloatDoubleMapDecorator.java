...
/**
 * Wrapper class to make a TFloatDoubleMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TFloatDoubleMap and translates
