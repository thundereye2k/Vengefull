...
/**
 * Wrapper class to make a TByteIntMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TByteIntMap and translates the
