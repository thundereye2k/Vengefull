...
/**
 * Wrapper class to make a TIntDoubleMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TIntDoubleMap and translates
...
public class TIntDoubleMapDecorator extends AbstractMap<Integer, Double>
	 ...
	 *
	 * @param map
	 *            the <tt>TIntDoubleMap</tt> to wrap.
	 */
