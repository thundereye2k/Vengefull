...
/**
 * Wrapper class to make a TCharObjectMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TCharObjectMap and translates
...
public class TCharObjectMapDecorator<V> extends AbstractMap<Character, V>
	 ...
	 *
	 * @param map
	 *            the <tt>TCharObjectMap</tt> to wrap.
	 */
