...
/**
 * Wrapper class to make a TDoubleList conform to the <tt>java.util.List</tt>
 * API. This class simply decorates an underlying TDoubleList and translates the
