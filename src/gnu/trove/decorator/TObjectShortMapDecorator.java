...
/**
 * Wrapper class to make a TObjectShortMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TObjectShortMap and translates
...
public class TObjectShortMapDecorator<K> extends AbstractMap<K, Short>
	 ...
	 *
	 * @param map
	 *            the <tt>TObjectShortMap</tt> to wrap.
	 */
