...
/**
 * Wrapper class to make a TByteByteMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TByteByteMap and translates
...
public class TByteByteMapDecorator extends AbstractMap<Byte, Byte>
	 ...
	 *
	 * @param map
	 *            the <tt>TByteByteMap</tt> to wrap.
	 */
