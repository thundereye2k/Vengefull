...
/**
 * Wrapper class to make a TShortShortMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TShortShortMap and translates
...
public class TShortShortMapDecorator extends AbstractMap<Short, Short>
	 ...
	 *
	 * @param map
	 *            the <tt>TShortShortMap</tt> to wrap.
	 */
