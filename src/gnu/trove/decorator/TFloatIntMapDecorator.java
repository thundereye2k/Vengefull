...
/**
 * Wrapper class to make a TFloatIntMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TFloatIntMap and translates
...
public class TFloatIntMapDecorator extends AbstractMap<Float, Integer>
	 ...
	 *
	 * @param map
	 *            the <tt>TFloatIntMap</tt> to wrap.
	 */
