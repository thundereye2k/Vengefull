...
/**
 * Wrapper class to make a TCharByteMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TCharByteMap and translates
...
public class TCharByteMapDecorator extends AbstractMap<Character, Byte>
	 ...
	 *
	 * @param map
	 *            the <tt>TCharByteMap</tt> to wrap.
	 */
