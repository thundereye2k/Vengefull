...
/**
 * Wrapper class to make a TLongDoubleMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TLongDoubleMap and translates
...
public class TLongDoubleMapDecorator extends AbstractMap<Long, Double>
	 ...
	 *
	 * @param map
	 *            the <tt>TLongDoubleMap</tt> to wrap.
	 */
