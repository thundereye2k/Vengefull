...
/**
 * Wrapper class to make a TShortDoubleMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TShortDoubleMap and translates
...
public class TShortDoubleMapDecorator extends AbstractMap<Short, Double>
	 ...
	 *
	 * @param map
	 *            the <tt>TShortDoubleMap</tt> to wrap.
	 */
