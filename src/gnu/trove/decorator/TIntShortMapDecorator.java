...
/**
 * Wrapper class to make a TIntShortMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TIntShortMap and translates
...
public class TIntShortMapDecorator extends AbstractMap<Integer, Short>
	 ...
	 *
	 * @param map
	 *            the <tt>TIntShortMap</tt> to wrap.
	 */
