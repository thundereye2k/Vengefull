...
/**
 * Wrapper class to make a TObjectByteMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TObjectByteMap and translates
...
public class TObjectByteMapDecorator<K> extends AbstractMap<K, Byte>
	 ...
	 *
	 * @param map
	 *            the <tt>TObjectByteMap</tt> to wrap.
	 */
