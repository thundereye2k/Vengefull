...
/**
 * Wrapper class to make a TByteFloatMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TByteFloatMap and translates
...
public class TByteFloatMapDecorator extends AbstractMap<Byte, Float>
	 ...
	 *
	 * @param map
	 *            the <tt>TByteFloatMap</tt> to wrap.
	 */
