...
/**
 * Wrapper class to make a TCharCharMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TCharCharMap and translates
...
public class TCharCharMapDecorator extends AbstractMap<Character, Character>
	 ...
	 *
	 * @param map
	 *            the <tt>TCharCharMap</tt> to wrap.
	 */
