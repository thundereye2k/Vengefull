...
/**
 * Wrapper class to make a TIntLongMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TIntLongMap and translates the
