...
/**
 * Wrapper class to make a TObjectLongMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TObjectLongMap and translates
...
public class TObjectLongMapDecorator<K> extends AbstractMap<K, Long>
	 ...
	 *
	 * @param map
	 *            the <tt>TObjectLongMap</tt> to wrap.
	 */
