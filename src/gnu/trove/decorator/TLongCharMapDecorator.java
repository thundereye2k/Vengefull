...
/**
 * Wrapper class to make a TLongCharMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TLongCharMap and translates
...
public class TLongCharMapDecorator extends AbstractMap<Long, Character>
	...
	public void putAll(Map<? extends Long, ? extends Character> map) {
		Iterator<? extends Entry<? extends Long, ? extends Character>> it = map.entrySet().iterator();
