...
/**
 * Wrapper class to make a TObjectCharMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TObjectCharMap and translates
...
public class TObjectCharMapDecorator<K> extends AbstractMap<K, Character>
	 ...
	 *
	 * @param map
	 *            the <tt>TObjectCharMap</tt> to wrap.
	 */
