...
/**
 * Wrapper class to make a TDoubleObjectMap conform to the
 * <tt>java.util.Map</tt> API. This class simply decorates an underlying
 * TDoubleObjectMap and translates the Object-based APIs into their Trove
 * primitive analogs.
 * <p/>
...
public class TDoubleObjectMapDecorator<V> extends AbstractMap<Double, V>
	 ...
	 *
	 * @param map
	 *            the <tt>TDoubleObjectMap</tt> to wrap.
	 */
