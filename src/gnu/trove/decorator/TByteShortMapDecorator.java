...
/**
 * Wrapper class to make a TByteShortMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TByteShortMap and translates
...
public class TByteShortMapDecorator extends AbstractMap<Byte, Short>
	 ...
	 *
	 * @param map
	 *            the <tt>TByteShortMap</tt> to wrap.
	 */
