...
/**
 * Wrapper class to make a TShortByteMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TShortByteMap and translates
...
public class TShortByteMapDecorator extends AbstractMap<Short, Byte>
	 ...
	 *
	 * @param map
	 *            the <tt>TShortByteMap</tt> to wrap.
	 */
