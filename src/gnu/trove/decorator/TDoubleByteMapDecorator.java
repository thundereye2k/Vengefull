...
/**
 * Wrapper class to make a TDoubleByteMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TDoubleByteMap and translates
...
public class TDoubleByteMapDecorator extends AbstractMap<Double, Byte>
	 ...
	 *
	 * @param map
	 *            the <tt>TDoubleByteMap</tt> to wrap.
	 */
