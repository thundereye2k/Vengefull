...
/**
 * Wrapper class to make a TShortObjectMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TShortObjectMap and translates
