...
/**
 * Wrapper class to make a TDoubleLongMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TDoubleLongMap and translates
...
public class TDoubleLongMapDecorator extends AbstractMap<Double, Long>
	 ...
	 *
	 * @param map
	 *            the <tt>TDoubleLongMap</tt> to wrap.
	 */
