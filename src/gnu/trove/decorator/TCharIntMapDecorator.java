...
/**
 * Wrapper class to make a TCharIntMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TCharIntMap and translates the
