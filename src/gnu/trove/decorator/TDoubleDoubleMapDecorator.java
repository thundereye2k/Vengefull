...
/**
 * Wrapper class to make a TDoubleDoubleMap conform to the
 * <tt>java.util.Map</tt> API. This class simply decorates an underlying
 * TDoubleDoubleMap and translates the Object-based APIs into their Trove
 * primitive analogs.
 * <p/>
...
public class TDoubleDoubleMapDecorator extends AbstractMap<Double, Double>
	 ...
	 * @param value
	 *            an <code>Object</code> value
	 * @return the previous value associated with <tt>key</tt>, or Double(0) if none
	 *         was found.
	 */
	@Override
