...
/**
 * Wrapper class to make a TFloatObjectMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TFloatObjectMap and translates
...
public class TFloatObjectMapDecorator<V> extends AbstractMap<Float, V>
	 ...
	 *
	 * @param map
	 *            the <tt>TFloatObjectMap</tt> to wrap.
	 */
