...
/**
 * Wrapper class to make a TFloatFloatMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TFloatFloatMap and translates
...
public class TFloatFloatMapDecorator extends AbstractMap<Float, Float>
	 ...
	 *
	 * @param map
	 *            the <tt>TFloatFloatMap</tt> to wrap.
	 */
