...
/**
 * Wrapper class to make a TFloatList conform to the <tt>java.util.List</tt>
 * API. This class simply decorates an underlying TFloatList and translates the
