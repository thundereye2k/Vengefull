...
/**
 * Wrapper class to make a TIntFloatMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TIntFloatMap and translates
...
public class TIntFloatMapDecorator extends AbstractMap<Integer, Float>
	 ...
	 *
	 * @param map
	 *            the <tt>TIntFloatMap</tt> to wrap.
	 */
