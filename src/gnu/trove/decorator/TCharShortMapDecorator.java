...
/**
 * Wrapper class to make a TCharShortMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TCharShortMap and translates
...
public class TCharShortMapDecorator extends AbstractMap<Character, Short>
	 ...
	 *
	 * @param map
	 *            the <tt>TCharShortMap</tt> to wrap.
	 */
