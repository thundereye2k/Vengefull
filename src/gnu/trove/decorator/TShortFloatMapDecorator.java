...
/**
 * Wrapper class to make a TShortFloatMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TShortFloatMap and translates
...
public class TShortFloatMapDecorator extends AbstractMap<Short, Float>
	 ...
	 *
	 * @param map
	 *            the <tt>TShortFloatMap</tt> to wrap.
	 */
