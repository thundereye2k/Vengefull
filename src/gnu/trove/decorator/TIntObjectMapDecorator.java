...
/**
 * Wrapper class to make a TIntObjectMap conform to the <tt>java.util.Map</tt>
 * API. This class simply decorates an underlying TIntObjectMap and translates
...
public class TIntObjectMapDecorator<V> extends AbstractMap<Integer, V>
	 ...
	 *
	 * @param map
	 *            the <tt>TIntObjectMap</tt> to wrap.
	 */
