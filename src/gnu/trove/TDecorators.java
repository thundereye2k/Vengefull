...
/**
 * This is a static utility class that provides functions for simplifying
...
public class TDecorators {
	...
	/**
	 * Wrap the given map in a decorator that uses the standard {@link java.util.Map
	 * Map} interface.
	 *
	 * @param map
	 *            the <tt>TDoubleDoubleObjectMap</tt> to be wrapped
	 ...
	 *
	 * @param map
	 *            the <tt>TDoubleFloatObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TDoubleIntObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TDoubleLongObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TDoubleByteObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TDoubleShortObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TDoubleCharObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TFloatFloatObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TFloatByteObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TFloatShortObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TFloatCharObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TIntDoubleObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TIntFloatObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TIntIntObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TIntLongObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TIntByteObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TIntShortObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TIntCharObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TLongDoubleObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TLongFloatObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TLongLongObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TLongByteObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TLongShortObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TByteDoubleObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TByteFloatObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TByteIntObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TByteLongObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TByteByteObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TByteShortObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TByteCharObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TShortDoubleObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TShortFloatObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TShortIntObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TShortLongObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TShortByteObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TShortShortObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TShortCharObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TCharDoubleObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TCharFloatObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TCharIntObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TCharLongObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TCharByteObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TCharShortObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TCharCharObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TObjectDoubleMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TObjectIntMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TObjectLongMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TObjectByteMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TObjectShortMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TObjectCharMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TFloatObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TIntObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TLongObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	 ...
	 *
	 * @param map
	 *            the <tt>TByteObjectMap</tt> to be wrapped
	 * @return the wrapped map.
	 */
	...
	/**
	 * Wrap the given set in a decorator that uses the standard {@link java.util.Set
	 * Set} interface.
	 *
	 * @param set
	 *            the <tt>TDoubleSet</tt> to be wrapped
	 ...
	 *
	 * @param set
	 *            the <tt>TFloatSet</tt> to be wrapped
	 * @return the wrapped set.
	 */
	 ...
	 *
	 * @param set
	 *            the <tt>TLongSet</tt> to be wrapped
	 * @return the wrapped set.
	 */
	 ...
	 *
	 * @param set
	 *            the <tt>TByteSet</tt> to be wrapped
	 * @return the wrapped set.
	 */
	 ...
	 *
	 * @param set
	 *            the <tt>TShortSet</tt> to be wrapped
	 * @return the wrapped set.
	 */
	 ...
	 *
	 * @param set
	 *            the <tt>TCharSet</tt> to be wrapped
	 * @return the wrapped set.
	 */
	 ...
	 * {@link java.util.List ListCommand} interface.
	 *
	 * @param list
	 *            the <tt>TDoubleList</tt> to be wrapped
	 ...
	 *
	 * @param list
	 *            the <tt>TFloatList</tt> to be wrapped
	 * @return the wrapped list.
	 */
	 ...
	 *
	 * @param list
	 *            the <tt>TIntList</tt> to be wrapped
	 * @return the wrapped list.
	 */
	 ...
	 *
	 * @param list
	 *            the <tt>TLongList</tt> to be wrapped
	 * @return the wrapped list.
	 */
	 ...
	 *
	 * @param list
	 *            the <tt>TByteList</tt> to be wrapped
	 * @return the wrapped list.
	 */
	 ...
	 *
	 * @param list
	 *            the <tt>TShortList</tt> to be wrapped
	 * @return the wrapped list.
	 */
	 ...
	 *
	 * @param list
	 *            the <tt>TCharList</tt> to be wrapped
	 * @return the wrapped list.
	 */
