...
public interface TDoubleObjectMap<V> {
	...
	/**
	 * Returns the value that represents null in the {@link #keySet()}. The default
	 ...
	 * mapping for a key <tt>k</tt> such that <tt>key.equals(k)</tt>. (There can be
	 ...
	 * {@link #containsKey(double) m.containsKey(k)} would return <tt>true</tt>.)
	 *
	 * @param key
	 *            key with which the specified value is to be associated
	 * @param value
	 *            an <tt>double</tt> value value to be associated with the specified
	 *            key
	 * @return the previous value associated with <tt>key</tt>, or
	 *         <tt>no_entry_value</tt> if there was no mapping for <tt>key</tt>. (A
	 *         <tt>no_entry_value</tt> return can also indicate that the map
	 ...
	 *            key with which the specified value is to be associated
	 * @param value
	 *            an <tt>double</tt> value to be associated with the specified key
	 *
	 * @return the previous value associated with <tt>key</tt>, or null if none was
	 *         found.
	 */
	 ...
	 * to value <tt>v</tt> such that <code>key.equals(k)</code>, that mapping is
	 ...
	 * {@link #put(double,Object) put(k, v)} on this map once for each mapping from
	...
	/**
	 * Returns a {@link TDoubleSet} view of the keys contained in this map. The set
	...
	/**
	 * Returns the values of the map as an Object array. Note that the array
	 * returned is typed as an Object[] and may not be cast to a more specific type.
	 * See {@link #values(V[])} for a version which allows specifically typed
	 * arrays. Changes to the array of values will not be reflected in the map nor
	 * vice-versa.
	 *
	...
	/**
	 * Returns a <tt>TDoubleObjectIterator</tt> with access to this map's keys and
	 * values.
	 *
	 * @return a <tt>TDoubleObjectIterator</tt> with access to this map's keys and
	 *         values.
	 */
	 ...
	 *
	 * @param procedure
	 *            a <code>TDoubleObjectProcedure</code> value
