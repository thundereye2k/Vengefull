...
public interface TObjectShortMap<K> {
	 ...
	 *
	 * @param value
	 *            <tt>short</tt> value whose presence in this map is to be tested
	 ...
	 * {@link #put(Object,short) put(k, v)} on this map once for each mapping from
	 ...
	 * from the map, via the <tt>TShortIterator.remove</tt>,
	 * <tt>TShortCollection.remove</tt>, <tt>removeAll</tt>, <tt>retainAll</tt> and
	...
	/**
	 * Returns the values of the map as an array of <tt>short</tt> values. Changes
	...
	/**
	 * Returns a <tt>TObjectShortIterator</tt> with access to this map's keys and
	 * values.
	 *
	 * @return a <tt>TObjectShortIterator</tt> with access to this map's keys and
	 *         values.
	 */
	 ...
	 *
	 * @param procedure
	 *            a <code>TOObjectShortProcedure</code> value
