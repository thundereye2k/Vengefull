...
public interface TFloatObjectMap<V> {
	 ...
	 * {@link #containsKey(float) m.containsKey(k)} would return <tt>true</tt>.)
	 *
	 * @param key
	 *            key with which the specified value is to be associated
	 * @param value
	 *            an <tt>float</tt> value value to be associated with the specified
	 *            key
	 ...
	 *            key with which the specified value is to be associated
	 * @param value
	 *            an <tt>float</tt> value to be associated with the specified key
	 *
	 ...
	 * {@link #put(float,Object) put(k, v)} on this map once for each mapping from
	...
	/**
	 * Returns a {@link TFloatSet} view of the keys contained in this map. The set
	...
	/**
	 * Returns a <tt>TFloatObjectIterator</tt> with access to this map's keys and
	 * values.
	 *
	 * @return a <tt>TFloatObjectIterator</tt> with access to this map's keys and
	 *         values.
	 */
	 ...
	 *
	 * @param procedure
	 *            a <code>TFloatObjectProcedure</code> value
