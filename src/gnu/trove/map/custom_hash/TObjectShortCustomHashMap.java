...
public class TObjectShortCustomHashMap<K> extends TCustomObjectHash<K> implements TObjectShortMap<K>, Externalizable {
	...
	/**
	 * Creates a new <code>TObjectShortHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TObjectShortHashMap</code> instance with a prime value at
	...
	/**
	 * Creates a new <code>TObjectShortCustomHashMap</code> that contains the
	 * entries in the map passed to it.
	 *
	 * @param map
	 *            the <tt>TObjectShortMap</tt> to be copied.
	 */
