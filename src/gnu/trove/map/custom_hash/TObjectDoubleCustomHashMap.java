...
public class TObjectDoubleCustomHashMap<K> extends TCustomObjectHash<K> implements TObjectDoubleMap<K>, Externalizable {
	...
	/**
	 * Creates a new <code>TObjectDoubleHashMap</code> instance with a prime value
	...
	/**
	 * Creates a new <code>TObjectDoubleCustomHashMap</code> that contains the
	 * entries in the map passed to it.
	 *
	 * @param map
	 *            the <tt>TObjectDoubleMap</tt> to be copied.
	 */
