...
public interface TObjectDoubleMap<K> {
	 ...
	 * <tt>(value==no_entry_value ? v==no_entry_value : value.equals(v))</tt>. This
	 ...
	 *
	 * @param value
	 *            <tt>double</tt> value whose presence in this map is to be tested
	 ...
	 * {@link #put(Object,double) put(k, v)} on this map once for each mapping from
	 ...
	 * from the map, via the <tt>TDoubleIterator.remove</tt>,
	 * <tt>TDoubleCollection.remove</tt>, <tt>removeAll</tt>, <tt>retainAll</tt> and
	...
	/**
	 * Returns the values of the map as an array of <tt>double</tt> values. Changes
	...
	/**
	 * Returns a <tt>TObjectDoubleIterator</tt> with access to this map's keys and
	 * values.
	 *
	 * @return a <tt>TObjectDoubleIterator</tt> with access to this map's keys and
	 *         values.
	 */
	 ...
	 *
	 * @param procedure
	 *            a <code>TOObjectDoubleProcedure</code> value
