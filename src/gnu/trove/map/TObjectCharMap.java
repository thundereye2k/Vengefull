...
public interface TObjectCharMap<K> {
	 ...
	 *
	 * @param value
	 *            <tt>char</tt> value whose presence in this map is to be tested
	 ...
	 * {@link #put(Object,char) put(k, v)} on this map once for each mapping from
	 ...
	 * from the map, via the <tt>TCharIterator.remove</tt>,
	 * <tt>TCharCollection.remove</tt>, <tt>removeAll</tt>, <tt>retainAll</tt> and
	...
	/**
	 * Returns the values of the map as an array of <tt>char</tt> values. Changes to
	...
	/**
	 * Returns a <tt>TObjectCharIterator</tt> with access to this map's keys and
	 * values.
	 *
	 * @return a <tt>TObjectCharIterator</tt> with access to this map's keys and
	 *         values.
	 */
	 ...
	 *
	 * @param procedure
	 *            a <code>TOObjectCharProcedure</code> value
