...
public interface TCharObjectMap<V> {
	 ...
	 * {@link #containsKey(char) m.containsKey(k)} would return <tt>true</tt>.)
	 *
	 * @param key
	 *            key with which the specified value is to be associated
	 * @param value
	 *            an <tt>char</tt> value value to be associated with the specified
	 *            key
	 ...
	 * {@link #put(char,Object) put(k, v)} on this map once for each mapping from
	...
	/**
	 * Returns a {@link TCharSet} view of the keys contained in this map. The set is
	...
	/**
	 * Returns a <tt>TCharObjectIterator</tt> with access to this map's keys and
	 * values.
	 *
	 * @return a <tt>TCharObjectIterator</tt> with access to this map's keys and
	 *         values.
	 */
	 ...
	 *
	 * @param procedure
	 *            a <code>TCharObjectProcedure</code> value
