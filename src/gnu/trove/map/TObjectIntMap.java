...
public interface TObjectIntMap<K> {
	 ...
	 * {@link #put(Object,int) put(k, v)} on this map once for each mapping from key
	 ...
	 * from the map, via the <tt>TIntIterator.remove</tt>,
	...
	/**
	 * Returns the values of the map as an array of <tt>int</tt> values. Changes to
