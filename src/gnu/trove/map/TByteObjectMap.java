...
public interface TByteObjectMap<V> {
	 ...
	 * {@link #containsKey(byte) m.containsKey(k)} would return <tt>true</tt>.)
	 *
	 * @param key
	 *            key with which the specified value is to be associated
	 * @param value
	 *            an <tt>byte</tt> value value to be associated with the specified
	 *            key
	 ...
	 * {@link #put(byte,Object) put(k, v)} on this map once for each mapping from
	...
	/**
	 * Returns a {@link TByteSet} view of the keys contained in this map. The set is
	...
	/**
	 * Returns a <tt>TByteObjectIterator</tt> with access to this map's keys and
	 * values.
	 *
	 * @return a <tt>TByteObjectIterator</tt> with access to this map's keys and
	 *         values.
	 */
	 ...
	 *
	 * @param procedure
	 *            a <code>TByteObjectProcedure</code> value
