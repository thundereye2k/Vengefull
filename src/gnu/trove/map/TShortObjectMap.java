...
public interface TShortObjectMap<V> {
	 ...
	 * {@link #containsKey(short) m.containsKey(k)} would return <tt>true</tt>.)
	 *
	 * @param key
	 *            key with which the specified value is to be associated
	 * @param value
	 *            an <tt>short</tt> value value to be associated with the specified
	 *            key
	 ...
	 *            key with which the specified value is to be associated
	 * @param value
	 *            an <tt>short</tt> value to be associated with the specified key
	 *
	 ...
	 * {@link #put(short,Object) put(k, v)} on this map once for each mapping from
	...
	/**
	 * Returns a {@link TShortSet} view of the keys contained in this map. The set
	...
	/**
	 * Returns a <tt>TShortObjectIterator</tt> with access to this map's keys and
	 * values.
	 *
	 * @return a <tt>TShortObjectIterator</tt> with access to this map's keys and
	 *         values.
	 */
	 ...
	 *
	 * @param procedure
	 *            a <code>TShortObjectProcedure</code> value
