...
public class TShortFloatHashMap extends TShortFloatHash implements TShortFloatMap, Externalizable {
	...
	/**
	 * Creates a new <code>TShortFloatHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TShortFloatHashMap</code> instance containing all of the
	...
	class TShortFloatHashIterator extends THashPrimitiveIterator implements TShortFloatIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TShortFloatHashMap</tt> we will be iterating over.
		 */
