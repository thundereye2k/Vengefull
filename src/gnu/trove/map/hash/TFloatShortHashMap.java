...
public class TFloatShortHashMap extends TFloatShortHash implements TFloatShortMap, Externalizable {
	...
	/**
	 * Creates a new <code>TFloatShortHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TFloatShortHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TFloatShortMap</tt> that will be duplicated.
	 */
	...
	class TFloatShortHashIterator extends THashPrimitiveIterator implements TFloatShortIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TFloatShortHashMap</tt> we will be iterating over.
		 */
