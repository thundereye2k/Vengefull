...
public class TCharByteHashMap extends TCharByteHash implements TCharByteMap, Externalizable {
	...
	/**
	 * Creates a new <code>TCharByteHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TCharByteHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TCharByteMap</tt> that will be duplicated.
	 */
	...
	class TCharByteHashIterator extends THashPrimitiveIterator implements TCharByteIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TCharByteHashMap</tt> we will be iterating over.
		 */
