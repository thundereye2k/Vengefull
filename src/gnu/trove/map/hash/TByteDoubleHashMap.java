...
public class TByteDoubleHashMap extends TByteDoubleHash implements TByteDoubleMap, Externalizable {
	...
	/**
	 * Creates a new <code>TByteDoubleHashMap</code> instance with a prime capacity
	 ...
	 *            Key set.
	 * @param noEntryValue
	 *            a <code>double</code> value that represents <tt>null</tt> for the
	 *            Value set.
	 */
	...
	/**
	 * Creates a new <code>TByteDoubleHashMap</code> instance containing all of the
	 * entries in the map passed in.
	 *
	 * @param keys
	 *            a <tt>byte</tt> array containing the keys for the matching values.
	 * @param values
	 *            a <tt>double</tt> array containing the values.
	 */
	 ...
	 *
	 * @param map
	 *            a <tt>TByteDoubleMap</tt> that will be duplicated.
	 */
	...
	class TByteDoubleHashIterator extends THashPrimitiveIterator implements TByteDoubleIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TByteDoubleHashMap</tt> we will be iterating over.
		 */
