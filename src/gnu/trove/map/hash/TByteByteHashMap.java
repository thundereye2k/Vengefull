...
public class TByteByteHashMap extends TByteByteHash implements TByteByteMap, Externalizable {
	...
	/**
	 * Creates a new <code>TByteByteHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TByteByteHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TByteByteMap</tt> that will be duplicated.
	 */
	...
	class TByteByteHashIterator extends THashPrimitiveIterator implements TByteByteIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TByteByteHashMap</tt> we will be iterating over.
		 */
