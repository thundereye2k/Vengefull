...
public class TDoubleIntHashMap extends TDoubleIntHash implements TDoubleIntMap, Externalizable {
	...
	/**
	 * Creates a new <code>TDoubleIntHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TDoubleIntHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TDoubleIntMap</tt> that will be duplicated.
	 */
	...
	class TDoubleIntHashIterator extends THashPrimitiveIterator implements TDoubleIntIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TDoubleIntHashMap</tt> we will be iterating over.
		 */
