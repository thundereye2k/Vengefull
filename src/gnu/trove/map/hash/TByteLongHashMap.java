...
public class TByteLongHashMap extends TByteLongHash implements TByteLongMap, Externalizable {
	...
	/**
	 * Creates a new <code>TByteLongHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TByteLongHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TByteLongMap</tt> that will be duplicated.
	 */
