...
public class TCharIntHashMap extends TCharIntHash implements TCharIntMap, Externalizable {
	...
	/**
	 * Creates a new <code>TCharIntHashMap</code> instance with the default capacity
	 * and load factor.
	 */
	...
	/**
	 * Creates a new <code>TCharIntHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TCharIntHashMap</code> instance containing all of the
	 * entries in the map passed in.
	 *
	 * @param keys
	 *            a <tt>char</tt> array containing the keys for the matching values.
	 * @param values
	 ...
	 *
	 * @param map
	 *            a <tt>TCharIntMap</tt> that will be duplicated.
	 */
	...
	class TCharIntHashIterator extends THashPrimitiveIterator implements TCharIntIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TCharIntHashMap</tt> we will be iterating over.
		 */
