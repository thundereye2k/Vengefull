...
public class TObjectCharHashMap<K> extends TObjectHash<K> implements TObjectCharMap<K>, Externalizable {
	...
	/**
	 * Creates a new <code>TObjectCharHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TObjectCharHashMap</code> instance with a prime value at
	...
	/**
	 * Creates a new <code>TObjectCharHashMap</code> that contains the entries in
	 * the map passed to it.
	 *
	 * @param map
	 *            the <tt>TObjectCharMap</tt> to be copied.
	 */
