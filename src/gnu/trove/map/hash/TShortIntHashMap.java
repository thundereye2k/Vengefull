...
public class TShortIntHashMap extends TShortIntHash implements TShortIntMap, Externalizable {
	...
	/**
	 * Creates a new <code>TShortIntHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TShortIntHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TShortIntMap</tt> that will be duplicated.
	 */
	...
	class TShortIntHashIterator extends THashPrimitiveIterator implements TShortIntIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TShortIntHashMap</tt> we will be iterating over.
		 */
