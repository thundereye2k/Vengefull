...
public class TByteFloatHashMap extends TByteFloatHash implements TByteFloatMap, Externalizable {
	...
	/**
	 * Creates a new <code>TByteFloatHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TByteFloatHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TByteFloatMap</tt> that will be duplicated.
	 */
	...
	class TByteFloatHashIterator extends THashPrimitiveIterator implements TByteFloatIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TByteFloatHashMap</tt> we will be iterating over.
		 */
