...
public class TShortLongHashMap extends TShortLongHash implements TShortLongMap, Externalizable {
	...
	/**
	 * Creates a new <code>TShortLongHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TShortLongHashMap</code> instance containing all of the
	...
	class TShortLongHashIterator extends THashPrimitiveIterator implements TShortLongIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TShortLongHashMap</tt> we will be iterating over.
		 */
