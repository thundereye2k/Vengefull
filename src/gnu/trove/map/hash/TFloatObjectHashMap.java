...
public class TFloatObjectHashMap<V> extends TFloatHash implements TFloatObjectMap<V>, Externalizable {
	...
	/**
	 * Creates a new <code>TFloatObjectHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TFloatObjectHashMap</code> instance with a prime value at
	...
	/**
	 * Creates a new <code>TFloatObjectHashMap</code> that contains the entries in
	 * the map passed to it.
	 *
	 * @param map
	 *            the <tt>TFloatObjectMap</tt> to be copied.
	 */
