...
public class TIntByteHashMap extends TIntByteHash implements TIntByteMap, Externalizable {
	...
	/**
	 * Creates a new <code>TIntByteHashMap</code> instance with the default capacity
	 * and load factor.
	 */
	...
	/**
	 * Creates a new <code>TIntByteHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TIntByteHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TIntByteMap</tt> that will be duplicated.
	 */
