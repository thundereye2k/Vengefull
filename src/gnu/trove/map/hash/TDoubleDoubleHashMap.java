...
public class TDoubleDoubleHashMap extends TDoubleDoubleHash implements TDoubleDoubleMap, Externalizable {
	...
	/**
	 * Creates a new <code>TDoubleDoubleHashMap</code> instance containing all of
	 * the entries in the map passed in.
	 *
	 * @param keys
	 ...
	 *
	 * @param map
	 *            a <tt>TDoubleDoubleMap</tt> that will be duplicated.
	 */
