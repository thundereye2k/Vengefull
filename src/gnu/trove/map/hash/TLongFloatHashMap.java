...
public class TLongFloatHashMap extends TLongFloatHash implements TLongFloatMap, Externalizable {
	...
	/**
	 * Creates a new <code>TLongFloatHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TLongFloatHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TLongFloatMap</tt> that will be duplicated.
	 */
	...
	class TLongFloatHashIterator extends THashPrimitiveIterator implements TLongFloatIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TLongFloatHashMap</tt> we will be iterating over.
		 */
