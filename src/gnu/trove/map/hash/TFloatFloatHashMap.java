...
public class TFloatFloatHashMap extends TFloatFloatHash implements TFloatFloatMap, Externalizable {
	...
	/**
	 * Creates a new <code>TFloatFloatHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TFloatFloatHashMap</code> instance containing all of the
	...
	class TFloatFloatHashIterator extends THashPrimitiveIterator implements TFloatFloatIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TFloatFloatHashMap</tt> we will be iterating over.
		 */
