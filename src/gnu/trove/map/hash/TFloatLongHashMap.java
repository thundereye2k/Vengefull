...
public class TFloatLongHashMap extends TFloatLongHash implements TFloatLongMap, Externalizable {
	...
	/**
	 * Creates a new <code>TFloatLongHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TFloatLongHashMap</code> instance containing all of the
	...
	class TFloatLongHashIterator extends THashPrimitiveIterator implements TFloatLongIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TFloatLongHashMap</tt> we will be iterating over.
		 */
