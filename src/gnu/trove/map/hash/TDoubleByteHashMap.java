...
public class TDoubleByteHashMap extends TDoubleByteHash implements TDoubleByteMap, Externalizable {
	...
	/**
	 * Creates a new <code>TDoubleByteHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TDoubleByteHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TDoubleByteMap</tt> that will be duplicated.
	 */
	...
	class TDoubleByteHashIterator extends THashPrimitiveIterator implements TDoubleByteIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TDoubleByteHashMap</tt> we will be iterating over.
		 */
