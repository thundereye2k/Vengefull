...
public class TIntFloatHashMap extends TIntFloatHash implements TIntFloatMap, Externalizable {
	...
	/**
	 * Creates a new <code>TIntFloatHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TIntFloatHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TIntFloatMap</tt> that will be duplicated.
	 */
	...
	class TIntFloatHashIterator extends THashPrimitiveIterator implements TIntFloatIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TIntFloatHashMap</tt> we will be iterating over.
		 */
