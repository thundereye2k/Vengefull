...
public class TCharCharHashMap extends TCharCharHash implements TCharCharMap, Externalizable {
	...
	/**
	 * Creates a new <code>TCharCharHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TCharCharHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TCharCharMap</tt> that will be duplicated.
	 */
