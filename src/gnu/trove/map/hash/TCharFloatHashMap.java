...
public class TCharFloatHashMap extends TCharFloatHash implements TCharFloatMap, Externalizable {
	...
	/**
	 * Creates a new <code>TCharFloatHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TCharFloatHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TCharFloatMap</tt> that will be duplicated.
	 */
	...
	class TCharFloatHashIterator extends THashPrimitiveIterator implements TCharFloatIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TCharFloatHashMap</tt> we will be iterating over.
		 */
