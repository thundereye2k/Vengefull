...
public class TLongByteHashMap extends TLongByteHash implements TLongByteMap, Externalizable {
	...
	/**
	 * Creates a new <code>TLongByteHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TLongByteHashMap</code> instance containing all of the
	...
	class TLongByteHashIterator extends THashPrimitiveIterator implements TLongByteIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TLongByteHashMap</tt> we will be iterating over.
		 */
