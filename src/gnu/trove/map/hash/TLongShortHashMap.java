...
public class TLongShortHashMap extends TLongShortHash implements TLongShortMap, Externalizable {
	...
	/**
	 * Creates a new <code>TLongShortHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TLongShortHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TLongShortMap</tt> that will be duplicated.
	 */
	...
	class TLongShortHashIterator extends THashPrimitiveIterator implements TLongShortIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TLongShortHashMap</tt> we will be iterating over.
		 */
