...
public class TObjectByteHashMap<K> extends TObjectHash<K> implements TObjectByteMap<K>, Externalizable {
	...
	/**
	 * Creates a new <code>TObjectByteHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TObjectByteHashMap</code> instance with a prime value at
	...
	/**
	 * Creates a new <code>TObjectByteHashMap</code> that contains the entries in
	 * the map passed to it.
	 *
	 * @param map
	 *            the <tt>TObjectByteMap</tt> to be copied.
	 */
