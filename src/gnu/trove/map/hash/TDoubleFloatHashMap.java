...
public class TDoubleFloatHashMap extends TDoubleFloatHash implements TDoubleFloatMap, Externalizable {
	...
	/**
	 * Creates a new <code>TDoubleFloatHashMap</code> instance with a prime capacity
	 ...
	 *            Key set.
	 * @param noEntryValue
	 *            a <code>float</code> value that represents <tt>null</tt> for the
	 *            Value set.
	 */
	...
	/**
	 * Creates a new <code>TDoubleFloatHashMap</code> instance containing all of the
	 * entries in the map passed in.
	 *
	 * @param keys
	 *            a <tt>double</tt> array containing the keys for the matching
	 *            values.
	 * @param values
	 *            a <tt>float</tt> array containing the values.
	 */
	 ...
	 *
	 * @param map
	 *            a <tt>TDoubleFloatMap</tt> that will be duplicated.
	 */
	...
	class TDoubleFloatHashIterator extends THashPrimitiveIterator implements TDoubleFloatIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TDoubleFloatHashMap</tt> we will be iterating over.
		 */
