...
public class TCharShortHashMap extends TCharShortHash implements TCharShortMap, Externalizable {
	...
	/**
	 * Creates a new <code>TCharShortHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TCharShortHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TCharShortMap</tt> that will be duplicated.
	 */
