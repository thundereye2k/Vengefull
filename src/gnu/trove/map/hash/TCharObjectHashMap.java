...
public class TCharObjectHashMap<V> extends TCharHash implements TCharObjectMap<V>, Externalizable {
	...
	/**
	 * Creates a new <code>TCharObjectHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TCharObjectHashMap</code> instance with a prime value at
	...
	/**
	 * Creates a new <code>TCharObjectHashMap</code> that contains the entries in
	 * the map passed to it.
	 *
	 * @param map
	 *            the <tt>TCharObjectMap</tt> to be copied.
	 */
