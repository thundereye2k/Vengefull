...
public class TShortByteHashMap extends TShortByteHash implements TShortByteMap, Externalizable {
	...
	/**
	 * Creates a new <code>TShortByteHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TShortByteHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TShortByteMap</tt> that will be duplicated.
	 */
	...
	class TShortByteHashIterator extends THashPrimitiveIterator implements TShortByteIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TShortByteHashMap</tt> we will be iterating over.
		 */
