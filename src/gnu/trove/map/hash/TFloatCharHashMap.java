...
public class TFloatCharHashMap extends TFloatCharHash implements TFloatCharMap, Externalizable {
	...
	/**
	 * Creates a new <code>TFloatCharHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TFloatCharHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TFloatCharMap</tt> that will be duplicated.
	 */
