...
public class TLongCharHashMap extends TLongCharHash implements TLongCharMap, Externalizable {
	...
	/**
	 * Creates a new <code>TLongCharHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TLongCharHashMap</code> instance containing all of the
	...
	class TLongCharHashIterator extends THashPrimitiveIterator implements TLongCharIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TLongCharHashMap</tt> we will be iterating over.
		 */
