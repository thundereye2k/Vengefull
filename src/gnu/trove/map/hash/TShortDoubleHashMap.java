...
public class TShortDoubleHashMap extends TShortDoubleHash implements TShortDoubleMap, Externalizable {
	...
	/**
	 * Creates a new <code>TShortDoubleHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TShortDoubleHashMap</code> instance containing all of the
	 * entries in the map passed in.
	 *
	 * @param keys
	 *            a <tt>short</tt> array containing the keys for the matching
	 *            values.
	 * @param values
	 ...
	 *
	 * @param map
	 *            a <tt>TShortDoubleMap</tt> that will be duplicated.
	 */
	...
	class TShortDoubleHashIterator extends THashPrimitiveIterator implements TShortDoubleIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TShortDoubleHashMap</tt> we will be iterating over.
		 */
