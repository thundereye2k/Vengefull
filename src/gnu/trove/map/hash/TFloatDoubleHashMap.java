...
public class TFloatDoubleHashMap extends TFloatDoubleHash implements TFloatDoubleMap, Externalizable {
	...
	/**
	 * Creates a new <code>TFloatDoubleHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TFloatDoubleHashMap</code> instance containing all of the
	 * entries in the map passed in.
	 *
	 * @param keys
	 *            a <tt>float</tt> array containing the keys for the matching
	 *            values.
	 * @param values
	 ...
	 *
	 * @param map
	 *            a <tt>TFloatDoubleMap</tt> that will be duplicated.
	 */
	...
	class TFloatDoubleHashIterator extends THashPrimitiveIterator implements TFloatDoubleIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TFloatDoubleHashMap</tt> we will be iterating over.
		 */
