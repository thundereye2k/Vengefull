...
public class TDoubleCharHashMap extends TDoubleCharHash implements TDoubleCharMap, Externalizable {
	...
	/**
	 * Creates a new <code>TDoubleCharHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TDoubleCharHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TDoubleCharMap</tt> that will be duplicated.
	 */
