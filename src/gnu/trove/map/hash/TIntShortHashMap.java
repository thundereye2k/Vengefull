...
public class TIntShortHashMap extends TIntShortHash implements TIntShortMap, Externalizable {
	...
	/**
	 * Creates a new <code>TIntShortHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TIntShortHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TIntShortMap</tt> that will be duplicated.
	 */
