...
public class TByteCharHashMap extends TByteCharHash implements TByteCharMap, Externalizable {
	...
	/**
	 * Creates a new <code>TByteCharHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TByteCharHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TByteCharMap</tt> that will be duplicated.
	 */
	...
	class TByteCharHashIterator extends THashPrimitiveIterator implements TByteCharIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TByteCharHashMap</tt> we will be iterating over.
		 */
