...
public class TShortCharHashMap extends TShortCharHash implements TShortCharMap, Externalizable {
	...
	/**
	 * Creates a new <code>TShortCharHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TShortCharHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TShortCharMap</tt> that will be duplicated.
	 */
