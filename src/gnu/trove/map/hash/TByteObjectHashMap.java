...
public class TByteObjectHashMap<V> extends TByteHash implements TByteObjectMap<V>, Externalizable {
	...
	/**
	 * Creates a new <code>TByteObjectHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TByteObjectHashMap</code> instance with a prime value at
	...
	/**
	 * Creates a new <code>TByteObjectHashMap</code> that contains the entries in
