...
public class TDoubleShortHashMap extends TDoubleShortHash implements TDoubleShortMap, Externalizable {
	...
	/**
	 * Creates a new <code>TDoubleShortHashMap</code> instance with a prime capacity
	 ...
	 *            Key set.
	 * @param noEntryValue
	 *            a <code>short</code> value that represents <tt>null</tt> for the
	 *            Value set.
	 */
	...
	/**
	 * Creates a new <code>TDoubleShortHashMap</code> instance containing all of the
	 ...
	 *            values.
	 * @param values
	 *            a <tt>short</tt> array containing the values.
	 */
	 ...
	 *
	 * @param map
	 *            a <tt>TDoubleShortMap</tt> that will be duplicated.
	 */
	...
	class TDoubleShortHashIterator extends THashPrimitiveIterator implements TDoubleShortIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TDoubleShortHashMap</tt> we will be iterating over.
		 */
