...
public class TByteShortHashMap extends TByteShortHash implements TByteShortMap, Externalizable {
	...
	/**
	 * Creates a new <code>TByteShortHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TByteShortHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TByteShortMap</tt> that will be duplicated.
	 */
	...
	class TByteShortHashIterator extends THashPrimitiveIterator implements TByteShortIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TByteShortHashMap</tt> we will be iterating over.
		 */
