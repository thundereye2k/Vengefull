...
public class TCharLongHashMap extends TCharLongHash implements TCharLongMap, Externalizable {
	...
	/**
	 * Creates a new <code>TCharLongHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TCharLongHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TCharLongMap</tt> that will be duplicated.
	 */
	...
	class TCharLongHashIterator extends THashPrimitiveIterator implements TCharLongIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TCharLongHashMap</tt> we will be iterating over.
		 */
