...
public class TDoubleLongHashMap extends TDoubleLongHash implements TDoubleLongMap, Externalizable {
	...
	/**
	 * Creates a new <code>TDoubleLongHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TDoubleLongHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TDoubleLongMap</tt> that will be duplicated.
	 */
	...
	class TDoubleLongHashIterator extends THashPrimitiveIterator implements TDoubleLongIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TDoubleLongHashMap</tt> we will be iterating over.
		 */
