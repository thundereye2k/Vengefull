...
public class TShortShortHashMap extends TShortShortHash implements TShortShortMap, Externalizable {
	...
	/**
	 * Creates a new <code>TShortShortHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TShortShortHashMap</code> instance containing all of the
	 ...
	 *
	 * @param map
	 *            a <tt>TShortShortMap</tt> that will be duplicated.
	 */
	...
	class TShortShortHashIterator extends THashPrimitiveIterator implements TShortShortIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TShortShortHashMap</tt> we will be iterating over.
		 */
