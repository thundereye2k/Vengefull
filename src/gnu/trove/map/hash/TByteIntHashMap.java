...
public class TByteIntHashMap extends TByteIntHash implements TByteIntMap, Externalizable {
	...
	/**
	 * Creates a new <code>TByteIntHashMap</code> instance with the default capacity
	 * and load factor.
	 */
	...
	/**
	 * Creates a new <code>TByteIntHashMap</code> instance with a prime capacity
	 ...
	 *            a <code>float</code> value
	 * @param noEntryKey
	 *            a <code>byte</code> value that represents <tt>null</tt> for the
	 *            Key set.
	 * @param noEntryValue
	 *            a <code>int</code> value that represents <tt>null</tt> for the
	 *            Value set.
	 */
	...
	/**
	 * Creates a new <code>TByteIntHashMap</code> instance containing all of the
	 * entries in the map passed in.
	 *
	 * @param keys
	 *            a <tt>byte</tt> array containing the keys for the matching values.
	 * @param values
	 ...
	 *
	 * @param map
	 *            a <tt>TByteIntMap</tt> that will be duplicated.
	 */
	...
	class TByteIntHashIterator extends THashPrimitiveIterator implements TByteIntIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TByteIntHashMap</tt> we will be iterating over.
		 */
