...
public class TIntDoubleHashMap extends TIntDoubleHash implements TIntDoubleMap, Externalizable {
	...
	/**
	 * Creates a new <code>TIntDoubleHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TIntDoubleHashMap</code> instance containing all of the
	...
	class TIntDoubleHashIterator extends THashPrimitiveIterator implements TIntDoubleIterator {
		 ...
		 *
		 * @param map
		 *            the <tt>TIntDoubleHashMap</tt> we will be iterating over.
		 */
