...
public class TShortObjectHashMap<V> extends TShortHash implements TShortObjectMap<V>, Externalizable {
	...
	/**
	 * Creates a new <code>TShortObjectHashMap</code> instance with a prime capacity
	...
	/**
	 * Creates a new <code>TShortObjectHashMap</code> instance with a prime value at
	...
	/**
	 * Creates a new <code>TShortObjectHashMap</code> that contains the entries in
	 * the map passed to it.
	 *
	 * @param map
	 *            the <tt>TShortObjectMap</tt> to be copied.
	 */
