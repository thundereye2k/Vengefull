...
public interface TObjectByteMap<K> {
	 ...
	 *
	 * @param value
	 *            <tt>byte</tt> value whose presence in this map is to be tested
	 ...
	 * {@link #put(Object,byte) put(k, v)} on this map once for each mapping from
	 ...
	 * from the map, via the <tt>TByteIterator.remove</tt>,
	 * <tt>TByteCollection.remove</tt>, <tt>removeAll</tt>, <tt>retainAll</tt> and
	...
	/**
	 * Returns the values of the map as an array of <tt>byte</tt> values. Changes to
	 * the array of values will not be reflected in the map nor vice-versa.
	 *
	...
	/**
	 * Returns a <tt>TObjectByteIterator</tt> with access to this map's keys and
	 * values.
	 *
	 * @return a <tt>TObjectByteIterator</tt> with access to this map's keys and
	 *         values.
	 */
