...
public interface TIntObjectMap<V> {
	 ...
	 * @param value
	 *            an <tt>int</tt> value value to be associated with the specified
	 *            key
	 ...
	 * {@link #put(int,Object) put(k, v)} on this map once for each mapping from key
	...
	/**
	 * Returns a {@link TIntSet} view of the keys contained in this map. The set is
