...
public interface TObjectFloatMap<K> {
	 ...
	 *
	 * @param value
	 *            <tt>float</tt> value whose presence in this map is to be tested
	 ...
	 * {@link #put(Object,float) put(k, v)} on this map once for each mapping from
	 ...
	 * from the map, via the <tt>TFloatIterator.remove</tt>,
	 * <tt>TFloatCollection.remove</tt>, <tt>removeAll</tt>, <tt>retainAll</tt> and
	...
	/**
	 * Returns the values of the map as an array of <tt>float</tt> values. Changes
	...
	/**
	 * Returns a <tt>TObjectFloatIterator</tt> with access to this map's keys and
	 * values.
	 *
	 * @return a <tt>TObjectFloatIterator</tt> with access to this map's keys and
	 *         values.
	 */
