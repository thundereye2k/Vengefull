...
public class TIntArrayStack implements TIntStack, Externalizable {
	...
	/**
	 * Creates a new <code>TIntArrayStack</code> instance with the default capacity.
	 */
	...
	/**
	 * Creates a new <code>TIntArrayStack</code> instance with the specified
	 * capacity.
	 *
	 * @param capacity
	...
	/**
	 * Creates a new <code>TIntArrayStack</code> instance that is a copy of the
	 * instanced passed to us.
	 *
	 * @param stack
	 ...
	 * pop them out of the stack. The front of the list will be the top of the
	 * stack.
	 *
	 * @return an <code>int[]</code> value
	 */
	 ...
	 * them out of the stack. The front of the list will be the top of the stack.
	 * <p>
	 * If the native array is smaller than the stack depth, the native array will be
	 * filled with the elements from the top of the array until it is full and
