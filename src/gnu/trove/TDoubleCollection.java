...
public interface TDoubleCollection {
	...
	/**
	 * Removes all of the elements in <tt>TDoubleCollection</tt> from the
	 * collection.
	 *
	 * @param collection
	 *            a <code>TDoubleCollection</code> value
	 ...
	 * collection. This ensures that <tt>s1.equals(s2)</tt> implies that
	 * <tt>s1.hashCode()==s2.hashCode()</tt> for any two collection <tt>s1</tt> and
